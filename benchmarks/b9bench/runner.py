            ...
            evidence.update(
                {
                    ...
                    "hrw_selected_cache_path_id": hrw_route.get("selectedCachePathId"),
                    ...
                    "complete_marker_on_selected_host": hrw_route.get("completeMarkerOnSelectedNode"),
                    "bytes_on_selected_host": hrw_route.get("bytesOnSelectedNode"),
                    "expected_bytes": hrw_route.get("expectedBytes"),
                    "selected_cache_path": hrw_route.get("selectedCachePath"),
