...
replace github.com/yandex-cloud/geesefs => github.com/beam-cloud/geesefs v0.0.0-20250515124011-f784d2be41a1

replace github.com/aws/aws-sdk-go => github.com/beam-cloud/geesefs/s3ext v0.0.0-20250515124011-f784d2be41a1
