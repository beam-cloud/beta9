...
replace github.com/yandex-cloud/geesefs => github.com/beam-cloud/geesefs v0.0.0-20250422182641-b0cb9eb6664c

replace github.com/aws/aws-sdk-go => github.com/beam-cloud/geesefs/s3ext v0.0.0-20250422182641-b0cb9eb6664c
