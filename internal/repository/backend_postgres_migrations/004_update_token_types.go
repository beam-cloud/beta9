...
func init() {
	goose.AddMigration(upAddTokenTypes, downRemoveTokenTypes)
}

func upAddTokenTypes(tx *sql.Tx) error {
	newTokenTypes := []string{"machine"}
...
func downRemoveTokenTypes(tx *sql.Tx) error {
