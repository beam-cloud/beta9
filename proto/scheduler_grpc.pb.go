...
const (
	...
	Scheduler_GetTaskStream_FullMethodName         = "/scheduler.Scheduler/GetTaskStream"
	Scheduler_GetNextTask_FullMethodName           = "/scheduler.Scheduler/GetNextTask"
	Scheduler_StartTask_FullMethodName             = "/scheduler.Scheduler/StartTask"
	Scheduler_EndTask_FullMethodName               = "/scheduler.Scheduler/EndTask"
	Scheduler_MonitorTask_FullMethodName           = "/scheduler.Scheduler/MonitorTask"
)
...
func (c *schedulerClient) GetTaskStream(ctx context.Context, in *GetTaskStreamRequest, opts ...grpc.CallOption) (Scheduler_GetTaskStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Scheduler_ServiceDesc.Streams[1], Scheduler_GetTaskStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *schedulerClient) GetNextTask(ctx context.Context, in *GetNextTaskRequest, opts ...grpc.CallOption) (*GetNextTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, Scheduler_GetNextTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *schedulerClient) EndTask(ctx context.Context, in *EndTaskRequest, opts ...grpc.CallOption) (*EndTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, Scheduler_EndTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *schedulerClient) MonitorTask(ctx context.Context, in *MonitorTaskRequest, opts ...grpc.CallOption) (Scheduler_MonitorTaskClient, error) {
	stream, err := c.cc.NewStream(ctx, &Scheduler_ServiceDesc.Streams[2], Scheduler_MonitorTask_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _Scheduler_GetNextTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Scheduler_GetNextTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Scheduler_EndTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Scheduler_EndTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
