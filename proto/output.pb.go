...
func file_output_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_output_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_output_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_output_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_output_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_output_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_output_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*OutputPublicURLRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_output_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*OutputPublicURLResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
