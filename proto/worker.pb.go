...
type RunCSandboxExecRequest struct {
	...
	GetPid      bool `protobuf:"varint,4,opt,name=get_pid,json=getPid,proto3" json:"get_pid,omitempty"` // Returns immediately with PID
	Blocking    bool `protobuf:"varint,5,opt,name=blocking,proto3" json:"blocking,omitempty"`           // Waits for completion and returns output
	Interactive bool `protobuf:"varint,6,opt,name=interactive,proto3" json:"interactive,omitempty"`     // Sets up interactive IO streams
	// For interactive mode
	Stdin []byte `protobuf:"bytes,7,opt,name=stdin,proto3" json:"stdin,omitempty"` // Only used in interactive mode
}
...
func (x *RunCSandboxExecRequest) GetGetPid() bool {
	if x != nil {
		return x.GetPid
	}
	return false
...
func (x *RunCSandboxExecRequest) GetBlocking() bool {
	if x != nil {
		return x.Blocking
	}
	return false
...
func (x *RunCSandboxExecRequest) GetStdin() []byte {
	if x != nil {
		return x.Stdin
	}
	return nil
...
var file_worker_proto_rawDesc = []byte{
	...
	0x4d, 0x73, 0x67, 0x22, 0xcc, 0x01, 0x0a, 0x16, 0x52, 0x75, 0x6e, 0x43, 0x53, 0x61, 0x6e, 0x64,
	...
	,
	...
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x70, 0x69, 0x64, 0x32, 0x93, 0x04, 0x0a,
...
var file_worker_proto_depIdxs = []int32{
	...
	12, // 5: runc.RunCService.RunCSyncWorkspace:input_type -> gateway.SyncContainerWorkspaceRequest
	10, // 6: runc.RunCService.RunCSandboxExec:input_type -> runc.RunCSandboxExecRequest
	1,  // 7: runc.RunCService.RunCKill:output_type -> runc.RunCKillResponse
	5,  // 8: runc.RunCService.RunCStatus:output_type -> runc.RunCStatusResponse
	3,  // 9: runc.RunCService.RunCExec:output_type -> runc.RunCExecResponse
	7,  // 10: runc.RunCService.RunCStreamLogs:output_type -> runc.RunCLogEntry
	9,  // 11: runc.RunCService.RunCArchive:output_type -> runc.RunCArchiveResponse
	13, // 12: runc.RunCService.RunCSyncWorkspace:output_type -> gateway.SyncContainerWorkspaceResponse
	11, // 13: runc.RunCService.RunCSandboxExec:output_type -> runc.RunCSandboxExecResponse
