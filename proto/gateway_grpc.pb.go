...
type GatewayServiceClient interface {
	...
	AttachToContainer(ctx context.Context, in *AttachToContainerRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AttachToContainerResponse], error)
	// Tasks
...
func (c *gatewayServiceClient) AttachToContainer(ctx context.Context, in *AttachToContainerRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AttachToContainerResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GatewayService_ServiceDesc.Streams[1], GatewayService_AttachToContainer_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[AttachToContainerRequest, AttachToContainerResponse]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GatewayService_AttachToContainerClient = grpc.ServerStreamingClient[AttachToContainerResponse]
...
type GatewayServiceServer interface {
	...
	AttachToContainer(*AttachToContainerRequest, grpc.ServerStreamingServer[AttachToContainerResponse]) error
	// Tasks
...
func (UnimplementedGatewayServiceServer) AttachToContainer(*AttachToContainerRequest, grpc.ServerStreamingServer[AttachToContainerResponse]) error {
...
func _GatewayService_AttachToContainer_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GatewayServiceServer).AttachToContainer(m, &grpc.GenericServerStream[AttachToContainerRequest, AttachToContainerResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GatewayService_AttachToContainerServer = grpc.ServerStreamingServer[AttachToContainerResponse]
