...
var file_gateway_proto_rawDesc = []byte{
	...
	0x6f, 0x6c, 0x52, 0x05, 0x70, 0x6f, 0x6f, 0x6c, 0x73, 0x22, 0x09, 0x0a, 0x07, 0x4d, 0x61, 0x63,
	0x68, 0x69, 0x6e, 0x65, 0x22, 0xc1, 0x01, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x4d, 0x61, 0x63,
	0x68, 0x69, 0x6e, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x43, 0x0a, 0x07,
	0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e,
	0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x4d, 0x61, 0x63, 0x68,
	0x69, 0x6e, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x46, 0x69, 0x6c, 0x74,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x6d, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74,
	...
	0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x73, 0x22, 0x16, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22,
	...
	0x68, 0x69, 0x6e, 0x65, 0x52, 0x07, 0x6d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x2a, 0x36, 0x0a,
	...
	0x45, 0x54, 0x45, 0x10, 0x01, 0x32, 0x99, 0x0a, 0x0a, 0x0e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61,
...
var file_gateway_proto_goTypes = []interface{}{
	...
	(*Machine)(nil),                      // 35: gateway.Machine
	(*ListMachinesRequest)(nil),          // 36: gateway.ListMachinesRequest
	(*ListMachinesResponse)(nil),         // 37: gateway.ListMachinesResponse
	(*CreateMachineRequest)(nil),         // 38: gateway.CreateMachineRequest
	(*CreateMachineResponse)(nil),        // 39: gateway.CreateMachineResponse
	nil,                                  // 40: gateway.ListTasksRequest.FiltersEntry
	nil,                                  // 41: gateway.ListDeploymentsRequest.FiltersEntry
	nil,                                  // 42: gateway.ListPoolsRequest.FiltersEntry
	nil,                                  // 43: gateway.ListMachinesRequest.FiltersEntry
...
var file_gateway_proto_depIdxs = []int32{
	...
	40, // 3: gateway.ListTasksRequest.filters:type_name -> gateway.ListTasksRequest.FiltersEntry
	44, // 4: gateway.Task.started_at:type_name -> google.protobuf.Timestamp
	44, // 5: gateway.Task.ended_at:type_name -> google.protobuf.Timestamp
	44, // 6: gateway.Task.created_at:type_name -> google.protobuf.Timestamp
	44, // 7: gateway.Task.updated_at:type_name -> google.protobuf.Timestamp
	...
	44, // 10: gateway.Deployment.created_at:type_name -> google.protobuf.Timestamp
	44, // 11: gateway.Deployment.updated_at:type_name -> google.protobuf.Timestamp
	41, // 12: gateway.ListDeploymentsRequest.filters:type_name -> gateway.ListDeploymentsRequest.FiltersEntry
	27, // 13: gateway.ListDeploymentsResponse.deployments:type_name -> gateway.Deployment
	42, // 14: gateway.ListPoolsRequest.filters:type_name -> gateway.ListPoolsRequest.FiltersEntry
	32, // 15: gateway.ListPoolsResponse.pools:type_name -> gateway.Pool
	43, // 16: gateway.ListMachinesRequest.filters:type_name -> gateway.ListMachinesRequest.FiltersEntry
	35, // 17: gateway.ListMachinesResponse.machines:type_name -> gateway.Machine
	35, // 18: gateway.CreateMachineResponse.machine:type_name -> gateway.Machine
	16, // 19: gateway.ListTasksRequest.FiltersEntry.value:type_name -> gateway.StringList
	16, // 20: gateway.ListDeploymentsRequest.FiltersEntry.value:type_name -> gateway.StringList
	16, // 21: gateway.ListPoolsRequest.FiltersEntry.value:type_name -> gateway.StringList
	16, // 22: gateway.ListMachinesRequest.FiltersEntry.value:type_name -> gateway.StringList
	...
	12, // 29: gateway.GatewayService.StartTask:input_type -> gateway.StartTaskRequest
	14, // 30: gateway.GatewayService.EndTask:input_type -> gateway.EndTaskRequest
	20, // 31: gateway.GatewayService.StopTasks:input_type -> gateway.StopTasksRequest
	17, // 32: gateway.GatewayService.ListTasks:input_type -> gateway.ListTasksRequest
	23, // 33: gateway.GatewayService.GetOrCreateStub:input_type -> gateway.GetOrCreateStubRequest
	25, // 34: gateway.GatewayService.DeployStub:input_type -> gateway.DeployStubRequest
	28, // 35: gateway.GatewayService.ListDeployments:input_type -> gateway.ListDeploymentsRequest
	30, // 36: gateway.GatewayService.StopDeployment:input_type -> gateway.StopDeploymentRequest
	33, // 37: gateway.GatewayService.ListPools:input_type -> gateway.ListPoolsRequest
	36, // 38: gateway.GatewayService.ListMachines:input_type -> gateway.ListMachinesRequest
	38, // 39: gateway.GatewayService.CreateMachine:input_type -> gateway.CreateMachineRequest
	2,  // 40: gateway.GatewayService.Authorize:output_type -> gateway.AuthorizeResponse
	4,  // 41: gateway.GatewayService.SignPayload:output_type -> gateway.SignPayloadResponse
	7,  // 42: gateway.GatewayService.HeadObject:output_type -> gateway.HeadObjectResponse
	9,  // 43: gateway.GatewayService.PutObject:output_type -> gateway.PutObjectResponse
	9,  // 44: gateway.GatewayService.PutObjectStream:output_type -> gateway.PutObjectResponse
	11, // 45: gateway.GatewayService.ReplaceObjectContent:output_type -> gateway.ReplaceObjectContentResponse
	13, // 46: gateway.GatewayService.StartTask:output_type -> gateway.StartTaskResponse
	15, // 47: gateway.GatewayService.EndTask:output_type -> gateway.EndTaskResponse
	21, // 48: gateway.GatewayService.StopTasks:output_type -> gateway.StopTasksResponse
	19, // 49: gateway.GatewayService.ListTasks:output_type -> gateway.ListTasksResponse
	24, // 50: gateway.GatewayService.GetOrCreateStub:output_type -> gateway.GetOrCreateStubResponse
	26, // 51: gateway.GatewayService.DeployStub:output_type -> gateway.DeployStubResponse
	29, // 52: gateway.GatewayService.ListDeployments:output_type -> gateway.ListDeploymentsResponse
	31, // 53: gateway.GatewayService.StopDeployment:output_type -> gateway.StopDeploymentResponse
	34, // 54: gateway.GatewayService.ListPools:output_type -> gateway.ListPoolsResponse
	37, // 55: gateway.GatewayService.ListMachines:output_type -> gateway.ListMachinesResponse
	39, // 56: gateway.GatewayService.CreateMachine:output_type -> gateway.CreateMachineResponse
