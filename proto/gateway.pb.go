...
var file_gateway_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x65, 0x22, 0xce, 0x01, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4d, 0x61,
	...
	0x61, 0x6e, 0x63, 0x68, 0x22, 0x52, 0x0a, 0x14, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4d, 0x61,
...
var file_gateway_proto_msgTypes = make([]protoimpl.MessageInfo, 85)
var file_gateway_proto_goTypes = []interface{}{
	...
	(*GetOrCreateStubRequest)(nil),         // 35: gateway.GetOrCreateStubRequest
	(*GetOrCreateStubResponse)(nil),        // 36: gateway.GetOrCreateStubResponse
	(*DeployStubRequest)(nil),              // 37: gateway.DeployStubRequest
	(*DeployStubResponse)(nil),             // 38: gateway.DeployStubResponse
	(*Deployment)(nil),                     // 39: gateway.Deployment
	(*ListDeploymentsRequest)(nil),         // 40: gateway.ListDeploymentsRequest
	(*ListDeploymentsResponse)(nil),        // 41: gateway.ListDeploymentsResponse
	(*StopDeploymentRequest)(nil),          // 42: gateway.StopDeploymentRequest
	(*StopDeploymentResponse)(nil),         // 43: gateway.StopDeploymentResponse
	(*StartDeploymentRequest)(nil),         // 44: gateway.StartDeploymentRequest
	(*StartDeploymentResponse)(nil),        // 45: gateway.StartDeploymentResponse
	(*ScaleDeploymentRequest)(nil),         // 46: gateway.ScaleDeploymentRequest
	(*ScaleDeploymentResponse)(nil),        // 47: gateway.ScaleDeploymentResponse
	(*DeleteDeploymentRequest)(nil),        // 48: gateway.DeleteDeploymentRequest
	(*DeleteDeploymentResponse)(nil),       // 49: gateway.DeleteDeploymentResponse
	(*Pool)(nil),                           // 50: gateway.Pool
	(*ListPoolsRequest)(nil),               // 51: gateway.ListPoolsRequest
	(*ListPoolsResponse)(nil),              // 52: gateway.ListPoolsResponse
	(*Machine)(nil),                        // 53: gateway.Machine
	(*MachineMetrics)(nil),                 // 54: gateway.MachineMetrics
	(*ListMachinesRequest)(nil),            // 55: gateway.ListMachinesRequest
	(*ListMachinesResponse)(nil),           // 56: gateway.ListMachinesResponse
	(*CreateMachineRequest)(nil),           // 57: gateway.CreateMachineRequest
	(*CreateMachineResponse)(nil),          // 58: gateway.CreateMachineResponse
	(*DeleteMachineRequest)(nil),           // 59: gateway.DeleteMachineRequest
	(*DeleteMachineResponse)(nil),          // 60: gateway.DeleteMachineResponse
	(*Token)(nil),                          // 61: gateway.Token
	(*ListTokensRequest)(nil),              // 62: gateway.ListTokensRequest
	(*ListTokensResponse)(nil),             // 63: gateway.ListTokensResponse
	(*CreateTokenRequest)(nil),             // 64: gateway.CreateTokenRequest
	(*CreateTokenResponse)(nil),            // 65: gateway.CreateTokenResponse
	(*ToggleTokenRequest)(nil),             // 66: gateway.ToggleTokenRequest
	(*ToggleTokenResponse)(nil),            // 67: gateway.ToggleTokenResponse
	(*DeleteTokenRequest)(nil),             // 68: gateway.DeleteTokenRequest
	(*DeleteTokenResponse)(nil),            // 69: gateway.DeleteTokenResponse
	(*GetURLRequest)(nil),                  // 70: gateway.GetURLRequest
	(*GetURLResponse)(nil),                 // 71: gateway.GetURLResponse
	(*ListWorkersRequest)(nil),             // 72: gateway.ListWorkersRequest
	(*ListWorkersResponse)(nil),            // 73: gateway.ListWorkersResponse
	(*CordonWorkerRequest)(nil),            // 74: gateway.CordonWorkerRequest
	(*CordonWorkerResponse)(nil),           // 75: gateway.CordonWorkerResponse
	(*UncordonWorkerRequest)(nil),          // 76: gateway.UncordonWorkerRequest
	(*UncordonWorkerResponse)(nil),         // 77: gateway.UncordonWorkerResponse
	(*DrainWorkerRequest)(nil),             // 78: gateway.DrainWorkerRequest
	(*DrainWorkerResponse)(nil),            // 79: gateway.DrainWorkerResponse
	(*ExportWorkspaceConfigRequest)(nil),   // 80: gateway.ExportWorkspaceConfigRequest
	(*ExportWorkspaceConfigResponse)(nil),  // 81: gateway.ExportWorkspaceConfigResponse
	nil,                                    // 82: gateway.ListTasksRequest.FiltersEntry
	nil,                                    // 83: gateway.ListDeploymentsRequest.FiltersEntry
	nil,                                    // 84: gateway.ListPoolsRequest.FiltersEntry
	nil,                                    // 85: gateway.ListMachinesResponse.GpusEntry
...
var file_gateway_proto_depIdxs = []int32{
	...
	86, // 4: gateway.ListContainersResponse.containers:type_name -> types.Container
	...
	82, // 7: gateway.ListTasksRequest.filters:type_name -> gateway.ListTasksRequest.FiltersEntry
	87, // 8: gateway.Task.started_at:type_name -> google.protobuf.Timestamp
	87, // 9: gateway.Task.ended_at:type_name -> google.protobuf.Timestamp
	87, // 10: gateway.Task.created_at:type_name -> google.protobuf.Timestamp
	87, // 11: gateway.Task.updated_at:type_name -> google.protobuf.Timestamp
	27, // 12: gateway.ListTasksResponse.tasks:type_name -> gateway.Task
	88, // 13: gateway.Volume.config:type_name -> types.MountPointConfig
	31, // 14: gateway.GetOrCreateStubRequest.volumes:type_name -> gateway.Volume
