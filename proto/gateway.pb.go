...
type GetOrCreateStubRequest struct {
	...
	Volumes       []byte `protobuf:"bytes,9,opt,name=volumes,proto3" json:"volumes,omitempty"`
}
...
func (x *GetOrCreateStubRequest) GetVolumes() []byte {
	if x != nil {
		return x.Volumes
	}
	return nil
...
var file_gateway_proto_rawDesc = []byte{
	...
	0x70, 0x75, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x73, 0x18, 0x09, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x07, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x73, 0x22, 0x42, 0x0a, 0x17,
	0x47, 0x65, 0x74, 0x4f, 0x72, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x74, 0x75, 0x62, 0x52,
