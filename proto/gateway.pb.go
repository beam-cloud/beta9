...
var file_gateway_proto_rawDesc = []byte{
	...
	0x6c, 0x73, 0x22, 0x88, 0x03, 0x0a, 0x07, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x12, 0x0e,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x22, 0x48, 0x0a,
	...
	0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x6d, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x4d,
	...
	0x63, 0x68, 0x69, 0x6e, 0x65, 0x73, 0x22, 0x33, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x10, 0x02, 0x32, 0x8e, 0x0c, 0x0a, 0x0e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x53, 0x65,
	...
	0x62, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x54, 0x0a, 0x0f, 0x4c, 0x69, 0x73,
...
var file_gateway_proto_goTypes = []interface{}{
	...
	(*ListMachinesRequest)(nil),          // 43: gateway.ListMachinesRequest
	(*ListMachinesResponse)(nil),         // 44: gateway.ListMachinesResponse
	(*CreateMachineRequest)(nil),         // 45: gateway.CreateMachineRequest
	(*CreateMachineResponse)(nil),        // 46: gateway.CreateMachineResponse
	(*DeleteMachineRequest)(nil),         // 47: gateway.DeleteMachineRequest
	(*DeleteMachineResponse)(nil),        // 48: gateway.DeleteMachineResponse
	nil,                                  // 49: gateway.ListTasksRequest.FiltersEntry
	nil,                                  // 50: gateway.ListDeploymentsRequest.FiltersEntry
	nil,                                  // 51: gateway.ListPoolsRequest.FiltersEntry
...
var file_gateway_proto_depIdxs = []int32{
	...
	52, // 3: gateway.Container.scheduled_at:type_name -> google.protobuf.Timestamp
	12, // 4: gateway.ListContainersResponse.containers:type_name -> gateway.Container
	49, // 5: gateway.ListTasksRequest.filters:type_name -> gateway.ListTasksRequest.FiltersEntry
	52, // 6: gateway.Task.started_at:type_name -> google.protobuf.Timestamp
	52, // 7: gateway.Task.ended_at:type_name -> google.protobuf.Timestamp
	52, // 8: gateway.Task.created_at:type_name -> google.protobuf.Timestamp
	52, // 9: gateway.Task.updated_at:type_name -> google.protobuf.Timestamp
	...
	52, // 14: gateway.Deployment.created_at:type_name -> google.protobuf.Timestamp
	52, // 15: gateway.Deployment.updated_at:type_name -> google.protobuf.Timestamp
	50, // 16: gateway.ListDeploymentsRequest.filters:type_name -> gateway.ListDeploymentsRequest.FiltersEntry
	34, // 17: gateway.ListDeploymentsResponse.deployments:type_name -> gateway.Deployment
	51, // 18: gateway.ListPoolsRequest.filters:type_name -> gateway.ListPoolsRequest.FiltersEntry
	39, // 19: gateway.ListPoolsResponse.pools:type_name -> gateway.Pool
	42, // 20: gateway.ListMachinesResponse.machines:type_name -> gateway.Machine
	42, // 21: gateway.CreateMachineResponse.machine:type_name -> gateway.Machine
	21, // 22: gateway.ListTasksRequest.FiltersEntry.value:type_name -> gateway.StringList
	21, // 23: gateway.ListDeploymentsRequest.FiltersEntry.value:type_name -> gateway.StringList
	21, // 24: gateway.ListPoolsRequest.FiltersEntry.value:type_name -> gateway.StringList
	1,  // 25: gateway.GatewayService.Authorize:input_type -> gateway.AuthorizeRequest
	3,  // 26: gateway.GatewayService.SignPayload:input_type -> gateway.SignPayloadRequest
	6,  // 27: gateway.GatewayService.HeadObject:input_type -> gateway.HeadObjectRequest
	8,  // 28: gateway.GatewayService.PutObject:input_type -> gateway.PutObjectRequest
	8,  // 29: gateway.GatewayService.PutObjectStream:input_type -> gateway.PutObjectRequest
	10, // 30: gateway.GatewayService.ReplaceObjectContent:input_type -> gateway.ReplaceObjectContentRequest
	13, // 31: gateway.GatewayService.ListContainers:input_type -> gateway.ListContainersRequest
	15, // 32: gateway.GatewayService.StopContainer:input_type -> gateway.StopContainerRequest
	17, // 33: gateway.GatewayService.StartTask:input_type -> gateway.StartTaskRequest
	19, // 34: gateway.GatewayService.EndTask:input_type -> gateway.EndTaskRequest
	25, // 35: gateway.GatewayService.StopTasks:input_type -> gateway.StopTasksRequest
	22, // 36: gateway.GatewayService.ListTasks:input_type -> gateway.ListTasksRequest
	30, // 37: gateway.GatewayService.GetOrCreateStub:input_type -> gateway.GetOrCreateStubRequest
	32, // 38: gateway.GatewayService.DeployStub:input_type -> gateway.DeployStubRequest
	35, // 39: gateway.GatewayService.ListDeployments:input_type -> gateway.ListDeploymentsRequest
	37, // 40: gateway.GatewayService.StopDeployment:input_type -> gateway.StopDeploymentRequest
	40, // 41: gateway.GatewayService.ListPools:input_type -> gateway.ListPoolsRequest
	43, // 42: gateway.GatewayService.ListMachines:input_type -> gateway.ListMachinesRequest
	45, // 43: gateway.GatewayService.CreateMachine:input_type -> gateway.CreateMachineRequest
	47, // 44: gateway.GatewayService.DeleteMachine:input_type -> gateway.DeleteMachineRequest
	2,  // 45: gateway.GatewayService.Authorize:output_type -> gateway.AuthorizeResponse
	4,  // 46: gateway.GatewayService.SignPayload:output_type -> gateway.SignPayloadResponse
	7,  // 47: gateway.GatewayService.HeadObject:output_type -> gateway.HeadObjectResponse
	9,  // 48: gateway.GatewayService.PutObject:output_type -> gateway.PutObjectResponse
	9,  // 49: gateway.GatewayService.PutObjectStream:output_type -> gateway.PutObjectResponse
	11, // 50: gateway.GatewayService.ReplaceObjectContent:output_type -> gateway.ReplaceObjectContentResponse
	14, // 51: gateway.GatewayService.ListContainers:output_type -> gateway.ListContainersResponse
	16, // 52: gateway.GatewayService.StopContainer:output_type -> gateway.StopContainerResponse
	18, // 53: gateway.GatewayService.StartTask:output_type -> gateway.StartTaskResponse
	20, // 54: gateway.GatewayService.EndTask:output_type -> gateway.EndTaskResponse
	26, // 55: gateway.GatewayService.StopTasks:output_type -> gateway.StopTasksResponse
	24, // 56: gateway.GatewayService.ListTasks:output_type -> gateway.ListTasksResponse
	31, // 57: gateway.GatewayService.GetOrCreateStub:output_type -> gateway.GetOrCreateStubResponse
	33, // 58: gateway.GatewayService.DeployStub:output_type -> gateway.DeployStubResponse
	36, // 59: gateway.GatewayService.ListDeployments:output_type -> gateway.ListDeploymentsResponse
	38, // 60: gateway.GatewayService.StopDeployment:output_type -> gateway.StopDeploymentResponse
	41, // 61: gateway.GatewayService.ListPools:output_type -> gateway.ListPoolsResponse
	44, // 62: gateway.GatewayService.ListMachines:output_type -> gateway.ListMachinesResponse
	46, // 63: gateway.GatewayService.CreateMachine:output_type -> gateway.CreateMachineResponse
	48, // 64: gateway.GatewayService.DeleteMachine:output_type -> gateway.DeleteMachineResponse
