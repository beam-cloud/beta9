...
var file_gateway_proto_rawDesc = []byte{
	...
	0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x50, 0x61, 0x74, 0x68, 0x22, 0xdf, 0x04, 0x0a, 0x16, 0x47, 0x65,
	...
	0x61, 0x72, 0x6d, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x12, 0x20, 0x0a, 0x0b, 0x63, 0x6f,
	0x6e, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x0b, 0x63, 0x6f, 0x6e, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x25, 0x0a, 0x0e,
	0x6d, 0x61, 0x78, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x73, 0x18, 0x0e,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x0d, 0x6d, 0x61, 0x78, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e,
	...
	0x63, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x55, 0x72, 0x6c, 0x22, 0x42, 0x0a, 0x17, 0x47,
	...
	0x73, 0x22, 0x09, 0x0a, 0x07, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x22, 0x48, 0x0a, 0x13,
	...
	0x67, 0x2a, 0x36, 0x0a, 0x1d, 0x52, 0x65, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x4f, 0x62, 0x6a, 0x65,
	...
	0x06, 0x44, 0x45, 0x4c, 0x45, 0x54, 0x45, 0x10, 0x01, 0x32, 0xbe, 0x0b, 0x0a, 0x0e, 0x47, 0x61,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x67, 0x0a, 0x14, 0x52,
	...
	0x22, 0x00, 0x28, 0x01, 0x12, 0x53, 0x0a, 0x0e, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x74,
...
var file_gateway_proto_goTypes = []interface{}{
	...
	(*GetOrCreateStubRequest)(nil),       // 26: gateway.GetOrCreateStubRequest
	(*GetOrCreateStubResponse)(nil),      // 27: gateway.GetOrCreateStubResponse
	(*DeployStubRequest)(nil),            // 28: gateway.DeployStubRequest
	(*DeployStubResponse)(nil),           // 29: gateway.DeployStubResponse
	(*Deployment)(nil),                   // 30: gateway.Deployment
	(*ListDeploymentsRequest)(nil),       // 31: gateway.ListDeploymentsRequest
	(*ListDeploymentsResponse)(nil),      // 32: gateway.ListDeploymentsResponse
	(*StopDeploymentRequest)(nil),        // 33: gateway.StopDeploymentRequest
	(*StopDeploymentResponse)(nil),       // 34: gateway.StopDeploymentResponse
	(*Pool)(nil),                         // 35: gateway.Pool
	(*ListPoolsRequest)(nil),             // 36: gateway.ListPoolsRequest
	(*ListPoolsResponse)(nil),            // 37: gateway.ListPoolsResponse
	(*Machine)(nil),                      // 38: gateway.Machine
	(*ListMachinesRequest)(nil),          // 39: gateway.ListMachinesRequest
	(*ListMachinesResponse)(nil),         // 40: gateway.ListMachinesResponse
	(*CreateMachineRequest)(nil),         // 41: gateway.CreateMachineRequest
	(*CreateMachineResponse)(nil),        // 42: gateway.CreateMachineResponse
	(*DeleteMachineRequest)(nil),         // 43: gateway.DeleteMachineRequest
	(*DeleteMachineResponse)(nil),        // 44: gateway.DeleteMachineResponse
	nil,                                  // 45: gateway.ListTasksRequest.FiltersEntry
	nil,                                  // 46: gateway.ListDeploymentsRequest.FiltersEntry
	nil,                                  // 47: gateway.ListPoolsRequest.FiltersEntry
...
var file_gateway_proto_depIdxs = []int32{
	...
	48, // 3: gateway.Container.scheduled_at:type_name -> google.protobuf.Timestamp
	12, // 4: gateway.ListContainersResponse.containers:type_name -> gateway.Container
	45, // 5: gateway.ListTasksRequest.filters:type_name -> gateway.ListTasksRequest.FiltersEntry
	48, // 6: gateway.Task.started_at:type_name -> google.protobuf.Timestamp
	48, // 7: gateway.Task.ended_at:type_name -> google.protobuf.Timestamp
	48, // 8: gateway.Task.created_at:type_name -> google.protobuf.Timestamp
	48, // 9: gateway.Task.updated_at:type_name -> google.protobuf.Timestamp
	...
	48, // 12: gateway.Deployment.created_at:type_name -> google.protobuf.Timestamp
	48, // 13: gateway.Deployment.updated_at:type_name -> google.protobuf.Timestamp
	46, // 14: gateway.ListDeploymentsRequest.filters:type_name -> gateway.ListDeploymentsRequest.FiltersEntry
	30, // 15: gateway.ListDeploymentsResponse.deployments:type_name -> gateway.Deployment
	47, // 16: gateway.ListPoolsRequest.filters:type_name -> gateway.ListPoolsRequest.FiltersEntry
	35, // 17: gateway.ListPoolsResponse.pools:type_name -> gateway.Pool
	38, // 18: gateway.ListMachinesResponse.machines:type_name -> gateway.Machine
	38, // 19: gateway.CreateMachineResponse.machine:type_name -> gateway.Machine
	19, // 20: gateway.ListTasksRequest.FiltersEntry.value:type_name -> gateway.StringList
	19, // 21: gateway.ListDeploymentsRequest.FiltersEntry.value:type_name -> gateway.StringList
	19, // 22: gateway.ListPoolsRequest.FiltersEntry.value:type_name -> gateway.StringList
	...
	15, // 30: gateway.GatewayService.StartTask:input_type -> gateway.StartTaskRequest
	17, // 31: gateway.GatewayService.EndTask:input_type -> gateway.EndTaskRequest
	23, // 32: gateway.GatewayService.StopTasks:input_type -> gateway.StopTasksRequest
	20, // 33: gateway.GatewayService.ListTasks:input_type -> gateway.ListTasksRequest
	26, // 34: gateway.GatewayService.GetOrCreateStub:input_type -> gateway.GetOrCreateStubRequest
	28, // 35: gateway.GatewayService.DeployStub:input_type -> gateway.DeployStubRequest
	31, // 36: gateway.GatewayService.ListDeployments:input_type -> gateway.ListDeploymentsRequest
	33, // 37: gateway.GatewayService.StopDeployment:input_type -> gateway.StopDeploymentRequest
	36, // 38: gateway.GatewayService.ListPools:input_type -> gateway.ListPoolsRequest
	39, // 39: gateway.GatewayService.ListMachines:input_type -> gateway.ListMachinesRequest
	41, // 40: gateway.GatewayService.CreateMachine:input_type -> gateway.CreateMachineRequest
	43, // 41: gateway.GatewayService.DeleteMachine:input_type -> gateway.DeleteMachineRequest
	2,  // 42: gateway.GatewayService.Authorize:output_type -> gateway.AuthorizeResponse
	4,  // 43: gateway.GatewayService.SignPayload:output_type -> gateway.SignPayloadResponse
	7,  // 44: gateway.GatewayService.HeadObject:output_type -> gateway.HeadObjectResponse
	9,  // 45: gateway.GatewayService.PutObject:output_type -> gateway.PutObjectResponse
	9,  // 46: gateway.GatewayService.PutObjectStream:output_type -> gateway.PutObjectResponse
	11, // 47: gateway.GatewayService.ReplaceObjectContent:output_type -> gateway.ReplaceObjectContentResponse
	14, // 48: gateway.GatewayService.ListContainers:output_type -> gateway.ListContainersResponse
	16, // 49: gateway.GatewayService.StartTask:output_type -> gateway.StartTaskResponse
	18, // 50: gateway.GatewayService.EndTask:output_type -> gateway.EndTaskResponse
	24, // 51: gateway.GatewayService.StopTasks:output_type -> gateway.StopTasksResponse
	22, // 52: gateway.GatewayService.ListTasks:output_type -> gateway.ListTasksResponse
	27, // 53: gateway.GatewayService.GetOrCreateStub:output_type -> gateway.GetOrCreateStubResponse
	29, // 54: gateway.GatewayService.DeployStub:output_type -> gateway.DeployStubResponse
	32, // 55: gateway.GatewayService.ListDeployments:output_type -> gateway.ListDeploymentsResponse
	34, // 56: gateway.GatewayService.StopDeployment:output_type -> gateway.StopDeploymentResponse
	37, // 57: gateway.GatewayService.ListPools:output_type -> gateway.ListPoolsResponse
	40, // 58: gateway.GatewayService.ListMachines:output_type -> gateway.ListMachinesResponse
	42, // 59: gateway.GatewayService.CreateMachine:output_type -> gateway.CreateMachineResponse
	44, // 60: gateway.GatewayService.DeleteMachine:output_type -> gateway.DeleteMachineResponse
