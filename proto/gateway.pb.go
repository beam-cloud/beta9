...
var file_gateway_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x69, 0x74, 0x22, 0x6d, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x4d, 0x61, 0x63, 0x68,
	...
	0x6e, 0x65, 0x73, 0x22, 0x33, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4d, 0x61, 0x63,
...
var file_gateway_proto_depIdxs = []int32{
	...
	55, // 3: gateway.Container.scheduled_at:type_name -> google.protobuf.Timestamp
	...
	55, // 6: gateway.Task.started_at:type_name -> google.protobuf.Timestamp
	55, // 7: gateway.Task.ended_at:type_name -> google.protobuf.Timestamp
	55, // 8: gateway.Task.created_at:type_name -> google.protobuf.Timestamp
	55, // 9: gateway.Task.updated_at:type_name -> google.protobuf.Timestamp
	...
	55, // 14: gateway.Deployment.created_at:type_name -> google.protobuf.Timestamp
	55, // 15: gateway.Deployment.updated_at:type_name -> google.protobuf.Timestamp
	...
	44, // 22: gateway.CreateMachineResponse.machine:type_name -> gateway.Machine
	21, // 23: gateway.ListTasksRequest.FiltersEntry.value:type_name -> gateway.StringList
	21, // 24: gateway.ListDeploymentsRequest.FiltersEntry.value:type_name -> gateway.StringList
	21, // 25: gateway.ListPoolsRequest.FiltersEntry.value:type_name -> gateway.StringList
	1,  // 26: gateway.GatewayService.Authorize:input_type -> gateway.AuthorizeRequest
	3,  // 27: gateway.GatewayService.SignPayload:input_type -> gateway.SignPayloadRequest
	6,  // 28: gateway.GatewayService.HeadObject:input_type -> gateway.HeadObjectRequest
	8,  // 29: gateway.GatewayService.PutObject:input_type -> gateway.PutObjectRequest
	8,  // 30: gateway.GatewayService.PutObjectStream:input_type -> gateway.PutObjectRequest
	10, // 31: gateway.GatewayService.ReplaceObjectContent:input_type -> gateway.ReplaceObjectContentRequest
	13, // 32: gateway.GatewayService.ListContainers:input_type -> gateway.ListContainersRequest
	15, // 33: gateway.GatewayService.StopContainer:input_type -> gateway.StopContainerRequest
	17, // 34: gateway.GatewayService.StartTask:input_type -> gateway.StartTaskRequest
	19, // 35: gateway.GatewayService.EndTask:input_type -> gateway.EndTaskRequest
	25, // 36: gateway.GatewayService.StopTasks:input_type -> gateway.StopTasksRequest
	22, // 37: gateway.GatewayService.ListTasks:input_type -> gateway.ListTasksRequest
	30, // 38: gateway.GatewayService.GetOrCreateStub:input_type -> gateway.GetOrCreateStubRequest
	32, // 39: gateway.GatewayService.DeployStub:input_type -> gateway.DeployStubRequest
	35, // 40: gateway.GatewayService.ListDeployments:input_type -> gateway.ListDeploymentsRequest
	37, // 41: gateway.GatewayService.StopDeployment:input_type -> gateway.StopDeploymentRequest
	39, // 42: gateway.GatewayService.DeleteDeployment:input_type -> gateway.DeleteDeploymentRequest
	42, // 43: gateway.GatewayService.ListPools:input_type -> gateway.ListPoolsRequest
	46, // 44: gateway.GatewayService.ListMachines:input_type -> gateway.ListMachinesRequest
	48, // 45: gateway.GatewayService.CreateMachine:input_type -> gateway.CreateMachineRequest
	50, // 46: gateway.GatewayService.DeleteMachine:input_type -> gateway.DeleteMachineRequest
	2,  // 47: gateway.GatewayService.Authorize:output_type -> gateway.AuthorizeResponse
	4,  // 48: gateway.GatewayService.SignPayload:output_type -> gateway.SignPayloadResponse
	7,  // 49: gateway.GatewayService.HeadObject:output_type -> gateway.HeadObjectResponse
	9,  // 50: gateway.GatewayService.PutObject:output_type -> gateway.PutObjectResponse
	9,  // 51: gateway.GatewayService.PutObjectStream:output_type -> gateway.PutObjectResponse
	11, // 52: gateway.GatewayService.ReplaceObjectContent:output_type -> gateway.ReplaceObjectContentResponse
	14, // 53: gateway.GatewayService.ListContainers:output_type -> gateway.ListContainersResponse
	16, // 54: gateway.GatewayService.StopContainer:output_type -> gateway.StopContainerResponse
	18, // 55: gateway.GatewayService.StartTask:output_type -> gateway.StartTaskResponse
	20, // 56: gateway.GatewayService.EndTask:output_type -> gateway.EndTaskResponse
	26, // 57: gateway.GatewayService.StopTasks:output_type -> gateway.StopTasksResponse
	24, // 58: gateway.GatewayService.ListTasks:output_type -> gateway.ListTasksResponse
	31, // 59: gateway.GatewayService.GetOrCreateStub:output_type -> gateway.GetOrCreateStubResponse
	33, // 60: gateway.GatewayService.DeployStub:output_type -> gateway.DeployStubResponse
	36, // 61: gateway.GatewayService.ListDeployments:output_type -> gateway.ListDeploymentsResponse
	38, // 62: gateway.GatewayService.StopDeployment:output_type -> gateway.StopDeploymentResponse
	40, // 63: gateway.GatewayService.DeleteDeployment:output_type -> gateway.DeleteDeploymentResponse
	43, // 64: gateway.GatewayService.ListPools:output_type -> gateway.ListPoolsResponse
	47, // 65: gateway.GatewayService.ListMachines:output_type -> gateway.ListMachinesResponse
	49, // 66: gateway.GatewayService.CreateMachine:output_type -> gateway.CreateMachineResponse
	51, // 67: gateway.GatewayService.DeleteMachine:output_type -> gateway.DeleteMachineResponse
