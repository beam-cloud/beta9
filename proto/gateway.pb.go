...
var file_gateway_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x2a, 0x36, 0x0a, 0x1d, 0x52,
	...
	0x45, 0x10, 0x01, 0x32, 0xe5, 0x07, 0x0a, 0x0e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x53,
	...
	0x6e, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x23, 0x5a, 0x21, 0x67,
...
var file_gateway_proto_goTypes = []interface{}{
	...
	nil,                                  // 30: gateway.ListTasksRequest.FiltersEntry
	nil,                                  // 31: gateway.ListDeploymentsRequest.FiltersEntry
...
var file_gateway_proto_depIdxs = []int32{
	...
	30, // 3: gateway.ListTasksRequest.filters:type_name -> gateway.ListTasksRequest.FiltersEntry
	32, // 4: gateway.Task.started_at:type_name -> google.protobuf.Timestamp
	32, // 5: gateway.Task.ended_at:type_name -> google.protobuf.Timestamp
	32, // 6: gateway.Task.created_at:type_name -> google.protobuf.Timestamp
	32, // 7: gateway.Task.updated_at:type_name -> google.protobuf.Timestamp
	...
	32, // 10: gateway.Deployment.created_at:type_name -> google.protobuf.Timestamp
	32, // 11: gateway.Deployment.updated_at:type_name -> google.protobuf.Timestamp
	31, // 12: gateway.ListDeploymentsRequest.filters:type_name -> gateway.ListDeploymentsRequest.FiltersEntry
	...
	2,  // 29: gateway.GatewayService.Authorize:output_type -> gateway.AuthorizeResponse
	4,  // 30: gateway.GatewayService.SignPayload:output_type -> gateway.SignPayloadResponse
	7,  // 31: gateway.GatewayService.HeadObject:output_type -> gateway.HeadObjectResponse
	9,  // 32: gateway.GatewayService.PutObject:output_type -> gateway.PutObjectResponse
	9,  // 33: gateway.GatewayService.PutObjectStream:output_type -> gateway.PutObjectResponse
	11, // 34: gateway.GatewayService.ReplaceObjectContent:output_type -> gateway.ReplaceObjectContentResponse
	13, // 35: gateway.GatewayService.StartTask:output_type -> gateway.StartTaskResponse
	15, // 36: gateway.GatewayService.EndTask:output_type -> gateway.EndTaskResponse
	21, // 37: gateway.GatewayService.StopTasks:output_type -> gateway.StopTasksResponse
	19, // 38: gateway.GatewayService.ListTasks:output_type -> gateway.ListTasksResponse
	24, // 39: gateway.GatewayService.GetOrCreateStub:output_type -> gateway.GetOrCreateStubResponse
	26, // 40: gateway.GatewayService.DeployStub:output_type -> gateway.DeployStubResponse
	29, // 41: gateway.GatewayService.ListDeployments:output_type -> gateway.ListDeploymentsResponse
