...
var file_gateway_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x6f, 0x6b, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x02, 0x6f, 0x6b, 0x12, 0x17, 0x0a, 0x07, 0x65, 0x72, 0x72, 0x5f, 0x6d, 0x73, 0x67,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x65, 0x72, 0x72, 0x4d, 0x73, 0x67, 0x22, 0xbe,
	...
	0x74, 0x57, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x47, 0x70, 0x75, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22,
	...
	0x10, 0x02, 0x32, 0xb9, 0x13, 0x0a, 0x0e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x53, 0x65,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x66, 0x0a, 0x15, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74,
	...
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x23,
...
var file_gateway_proto_depIdxs = []int32{
	...
	77, // 19: gateway.ListPoolsRequest.filters:type_name -> gateway.ListPoolsRequest.FiltersEntry
	43, // 20: gateway.ListPoolsResponse.pools:type_name -> gateway.Pool
	47, // 21: gateway.Machine.machine_metrics:type_name -> gateway.MachineMetrics
	46, // 22: gateway.ListMachinesResponse.machines:type_name -> gateway.Machine
	78, // 23: gateway.ListMachinesResponse.gpus:type_name -> gateway.ListMachinesResponse.GpusEntry
	46, // 24: gateway.CreateMachineResponse.machine:type_name -> gateway.Machine
	80, // 25: gateway.Token.created_at:type_name -> google.protobuf.Timestamp
	80, // 26: gateway.Token.updated_at:type_name -> google.protobuf.Timestamp
	54, // 27: gateway.ListTokensResponse.tokens:type_name -> gateway.Token
	54, // 28: gateway.CreateTokenResponse.token:type_name -> gateway.Token
	54, // 29: gateway.ToggleTokenResponse.token:type_name -> gateway.Token
	82, // 30: gateway.ListWorkersResponse.workers:type_name -> types.Worker
	20, // 31: gateway.ListTasksRequest.FiltersEntry.value:type_name -> gateway.StringList
	20, // 32: gateway.ListDeploymentsRequest.FiltersEntry.value:type_name -> gateway.StringList
	20, // 33: gateway.ListPoolsRequest.FiltersEntry.value:type_name -> gateway.StringList
	1,  // 34: gateway.GatewayService.Authorize:input_type -> gateway.AuthorizeRequest
	3,  // 35: gateway.GatewayService.SignPayload:input_type -> gateway.SignPayloadRequest
	6,  // 36: gateway.GatewayService.HeadObject:input_type -> gateway.HeadObjectRequest
	8,  // 37: gateway.GatewayService.PutObject:input_type -> gateway.PutObjectRequest
	8,  // 38: gateway.GatewayService.PutObjectStream:input_type -> gateway.PutObjectRequest
	10, // 39: gateway.GatewayService.ReplaceObjectContent:input_type -> gateway.ReplaceObjectContentRequest
	12, // 40: gateway.GatewayService.ListContainers:input_type -> gateway.ListContainersRequest
	14, // 41: gateway.GatewayService.StopContainer:input_type -> gateway.StopContainerRequest
	16, // 42: gateway.GatewayService.StartTask:input_type -> gateway.StartTaskRequest
	18, // 43: gateway.GatewayService.EndTask:input_type -> gateway.EndTaskRequest
	24, // 44: gateway.GatewayService.StopTasks:input_type -> gateway.StopTasksRequest
	21, // 45: gateway.GatewayService.ListTasks:input_type -> gateway.ListTasksRequest
	30, // 46: gateway.GatewayService.GetOrCreateStub:input_type -> gateway.GetOrCreateStubRequest
	32, // 47: gateway.GatewayService.DeployStub:input_type -> gateway.DeployStubRequest
	63, // 48: gateway.GatewayService.GetURL:input_type -> gateway.GetURLRequest
	35, // 49: gateway.GatewayService.ListDeployments:input_type -> gateway.ListDeploymentsRequest
	37, // 50: gateway.GatewayService.StopDeployment:input_type -> gateway.StopDeploymentRequest
	39, // 51: gateway.GatewayService.StartDeployment:input_type -> gateway.StartDeploymentRequest
	...
	65, // 61: gateway.GatewayService.ListWorkers:input_type -> gateway.ListWorkersRequest
	67, // 62: gateway.GatewayService.CordonWorker:input_type -> gateway.CordonWorkerRequest
	69, // 63: gateway.GatewayService.UncordonWorker:input_type -> gateway.UncordonWorkerRequest
	71, // 64: gateway.GatewayService.DrainWorker:input_type -> gateway.DrainWorkerRequest
	73, // 65: gateway.GatewayService.ExportWorkspaceConfig:input_type -> gateway.ExportWorkspaceConfigRequest
	...
	13, // 72: gateway.GatewayService.ListContainers:output_type -> gateway.ListContainersResponse
	15, // 73: gateway.GatewayService.StopContainer:output_type -> gateway.StopContainerResponse
	17, // 74: gateway.GatewayService.StartTask:output_type -> gateway.StartTaskResponse
	19, // 75: gateway.GatewayService.EndTask:output_type -> gateway.EndTaskResponse
	25, // 76: gateway.GatewayService.StopTasks:output_type -> gateway.StopTasksResponse
	23, // 77: gateway.GatewayService.ListTasks:output_type -> gateway.ListTasksResponse
	31, // 78: gateway.GatewayService.GetOrCreateStub:output_type -> gateway.GetOrCreateStubResponse
	33, // 79: gateway.GatewayService.DeployStub:output_type -> gateway.DeployStubResponse
	64, // 80: gateway.GatewayService.GetURL:output_type -> gateway.GetURLResponse
	36, // 81: gateway.GatewayService.ListDeployments:output_type -> gateway.ListDeploymentsResponse
	38, // 82: gateway.GatewayService.StopDeployment:output_type -> gateway.StopDeploymentResponse
	40, // 83: gateway.GatewayService.StartDeployment:output_type -> gateway.StartDeploymentResponse
	...
	66, // 93: gateway.GatewayService.ListWorkers:output_type -> gateway.ListWorkersResponse
	68, // 94: gateway.GatewayService.CordonWorker:output_type -> gateway.CordonWorkerResponse
	70, // 95: gateway.GatewayService.UncordonWorker:output_type -> gateway.UncordonWorkerResponse
	72, // 96: gateway.GatewayService.DrainWorker:output_type -> gateway.DrainWorkerResponse
	74, // 97: gateway.GatewayService.ExportWorkspaceConfig:output_type -> gateway.ExportWorkspaceConfigResponse
