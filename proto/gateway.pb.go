...
var file_gateway_proto_rawDesc = []byte{
	...
	0x61, 0x69, 0x6e, 0x65, 0x72, 0x22, 0xb3, 0x05, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x43,
	...
	0x0a, 0x61, 0x75, 0x74, 0x6f, 0x73, 0x63, 0x61, 0x6c, 0x65, 0x72, 0x22, 0x5b, 0x0a, 0x17, 0x47,
	...
	0x52, 0x06, 0x65, 0x72, 0x72, 0x4d, 0x73, 0x67, 0x22, 0x40, 0x0a, 0x11, 0x44, 0x65, 0x70, 0x6c,
	...
	0x6f, 0x6f, 0x6c, 0x52, 0x05, 0x70, 0x6f, 0x6f, 0x6c, 0x73, 0x22, 0xef, 0x03, 0x0a, 0x07, 0x4d,
	...
	0x63, 0x68, 0x69, 0x6e, 0x65, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x22, 0xf3, 0x03, 0x0a,
	...
	0x72, 0x4d, 0x73, 0x67, 0x2a, 0x41, 0x0a, 0x1d, 0x52, 0x65, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x4f,
	...
	0x4d, 0x4f, 0x56, 0x45, 0x44, 0x10, 0x02, 0x32, 0x8c, 0x0f, 0x0a, 0x0e, 0x47, 0x61, 0x74, 0x65,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x65, 0x0a, 0x14, 0x52, 0x65, 0x70,
	0x6c, 0x61, 0x63, 0x65, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e,
	0x74, 0x12, 0x24, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x52, 0x65, 0x70, 0x6c,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x42, 0x0a, 0x09, 0x53, 0x74, 0x61, 0x72, 0x74,
	...
	0x6f, 0x79, 0x53, 0x74, 0x75, 0x62, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x54,
...
var file_gateway_proto_msgTypes = make([]protoimpl.MessageInfo, 65)
var file_gateway_proto_goTypes = []interface{}{
	...
	(*DeleteDeploymentRequest)(nil),      // 40: gateway.DeleteDeploymentRequest
	(*DeleteDeploymentResponse)(nil),     // 41: gateway.DeleteDeploymentResponse
	(*Pool)(nil),                         // 42: gateway.Pool
	(*ListPoolsRequest)(nil),             // 43: gateway.ListPoolsRequest
	(*ListPoolsResponse)(nil),            // 44: gateway.ListPoolsResponse
	(*Machine)(nil),                      // 45: gateway.Machine
	(*MachineMetrics)(nil),               // 46: gateway.MachineMetrics
	(*ListMachinesRequest)(nil),          // 47: gateway.ListMachinesRequest
	(*ListMachinesResponse)(nil),         // 48: gateway.ListMachinesResponse
	(*CreateMachineRequest)(nil),         // 49: gateway.CreateMachineRequest
	(*CreateMachineResponse)(nil),        // 50: gateway.CreateMachineResponse
	(*DeleteMachineRequest)(nil),         // 51: gateway.DeleteMachineRequest
	(*DeleteMachineResponse)(nil),        // 52: gateway.DeleteMachineResponse
	(*Token)(nil),                        // 53: gateway.Token
	(*ListTokensRequest)(nil),            // 54: gateway.ListTokensRequest
	(*ListTokensResponse)(nil),           // 55: gateway.ListTokensResponse
	(*CreateTokenRequest)(nil),           // 56: gateway.CreateTokenRequest
	(*CreateTokenResponse)(nil),          // 57: gateway.CreateTokenResponse
	(*ToggleTokenRequest)(nil),           // 58: gateway.ToggleTokenRequest
	(*ToggleTokenResponse)(nil),          // 59: gateway.ToggleTokenResponse
	(*DeleteTokenRequest)(nil),           // 60: gateway.DeleteTokenRequest
	(*DeleteTokenResponse)(nil),          // 61: gateway.DeleteTokenResponse
	nil,                                  // 62: gateway.ListTasksRequest.FiltersEntry
	nil,                                  // 63: gateway.ListDeploymentsRequest.FiltersEntry
	nil,                                  // 64: gateway.ListPoolsRequest.FiltersEntry
	nil,                                  // 65: gateway.ListMachinesResponse.GpusEntry
...
var file_gateway_proto_depIdxs = []int32{
	...
	66, // 3: gateway.Container.scheduled_at:type_name -> google.protobuf.Timestamp
	12, // 4: gateway.ListContainersResponse.containers:type_name -> gateway.Container
	62, // 5: gateway.ListTasksRequest.filters:type_name -> gateway.ListTasksRequest.FiltersEntry
	66, // 6: gateway.Task.started_at:type_name -> google.protobuf.Timestamp
	66, // 7: gateway.Task.ended_at:type_name -> google.protobuf.Timestamp
	66, // 8: gateway.Task.created_at:type_name -> google.protobuf.Timestamp
	66, // 9: gateway.Task.updated_at:type_name -> google.protobuf.Timestamp
	...
	66, // 15: gateway.Deployment.created_at:type_name -> google.protobuf.Timestamp
	66, // 16: gateway.Deployment.updated_at:type_name -> google.protobuf.Timestamp
	63, // 17: gateway.ListDeploymentsRequest.filters:type_name -> gateway.ListDeploymentsRequest.FiltersEntry
	35, // 18: gateway.ListDeploymentsResponse.deployments:type_name -> gateway.Deployment
	64, // 19: gateway.ListPoolsRequest.filters:type_name -> gateway.ListPoolsRequest.FiltersEntry
	42, // 20: gateway.ListPoolsResponse.pools:type_name -> gateway.Pool
	46, // 21: gateway.Machine.machine_metrics:type_name -> gateway.MachineMetrics
	45, // 22: gateway.ListMachinesResponse.machines:type_name -> gateway.Machine
	65, // 23: gateway.ListMachinesResponse.gpus:type_name -> gateway.ListMachinesResponse.GpusEntry
	45, // 24: gateway.CreateMachineResponse.machine:type_name -> gateway.Machine
	66, // 25: gateway.Token.created_at:type_name -> google.protobuf.Timestamp
	66, // 26: gateway.Token.updated_at:type_name -> google.protobuf.Timestamp
	53, // 27: gateway.ListTokensResponse.tokens:type_name -> gateway.Token
	53, // 28: gateway.CreateTokenResponse.token:type_name -> gateway.Token
	53, // 29: gateway.ToggleTokenResponse.token:type_name -> gateway.Token
	21, // 30: gateway.ListTasksRequest.FiltersEntry.value:type_name -> gateway.StringList
	21, // 31: gateway.ListDeploymentsRequest.FiltersEntry.value:type_name -> gateway.StringList
	21, // 32: gateway.ListPoolsRequest.FiltersEntry.value:type_name -> gateway.StringList
	1,  // 33: gateway.GatewayService.Authorize:input_type -> gateway.AuthorizeRequest
	3,  // 34: gateway.GatewayService.SignPayload:input_type -> gateway.SignPayloadRequest
	6,  // 35: gateway.GatewayService.HeadObject:input_type -> gateway.HeadObjectRequest
	8,  // 36: gateway.GatewayService.PutObject:input_type -> gateway.PutObjectRequest
	8,  // 37: gateway.GatewayService.PutObjectStream:input_type -> gateway.PutObjectRequest
	10, // 38: gateway.GatewayService.ReplaceObjectContent:input_type -> gateway.ReplaceObjectContentRequest
	13, // 39: gateway.GatewayService.ListContainers:input_type -> gateway.ListContainersRequest
	15, // 40: gateway.GatewayService.StopContainer:input_type -> gateway.StopContainerRequest
	17, // 41: gateway.GatewayService.StartTask:input_type -> gateway.StartTaskRequest
	19, // 42: gateway.GatewayService.EndTask:input_type -> gateway.EndTaskRequest
	25, // 43: gateway.GatewayService.StopTasks:input_type -> gateway.StopTasksRequest
	22, // 44: gateway.GatewayService.ListTasks:input_type -> gateway.ListTasksRequest
	31, // 45: gateway.GatewayService.GetOrCreateStub:input_type -> gateway.GetOrCreateStubRequest
	33, // 46: gateway.GatewayService.DeployStub:input_type -> gateway.DeployStubRequest
	36, // 47: gateway.GatewayService.ListDeployments:input_type -> gateway.ListDeploymentsRequest
	38, // 48: gateway.GatewayService.StopDeployment:input_type -> gateway.StopDeploymentRequest
	40, // 49: gateway.GatewayService.DeleteDeployment:input_type -> gateway.DeleteDeploymentRequest
	43, // 50: gateway.GatewayService.ListPools:input_type -> gateway.ListPoolsRequest
	47, // 51: gateway.GatewayService.ListMachines:input_type -> gateway.ListMachinesRequest
	49, // 52: gateway.GatewayService.CreateMachine:input_type -> gateway.CreateMachineRequest
	51, // 53: gateway.GatewayService.DeleteMachine:input_type -> gateway.DeleteMachineRequest
	54, // 54: gateway.GatewayService.ListTokens:input_type -> gateway.ListTokensRequest
	56, // 55: gateway.GatewayService.CreateToken:input_type -> gateway.CreateTokenRequest
	58, // 56: gateway.GatewayService.ToggleToken:input_type -> gateway.ToggleTokenRequest
	60, // 57: gateway.GatewayService.DeleteToken:input_type -> gateway.DeleteTokenRequest
	2,  // 58: gateway.GatewayService.Authorize:output_type -> gateway.AuthorizeResponse
	4,  // 59: gateway.GatewayService.SignPayload:output_type -> gateway.SignPayloadResponse
	7,  // 60: gateway.GatewayService.HeadObject:output_type -> gateway.HeadObjectResponse
	9,  // 61: gateway.GatewayService.PutObject:output_type -> gateway.PutObjectResponse
	9,  // 62: gateway.GatewayService.PutObjectStream:output_type -> gateway.PutObjectResponse
	11, // 63: gateway.GatewayService.ReplaceObjectContent:output_type -> gateway.ReplaceObjectContentResponse
	14, // 64: gateway.GatewayService.ListContainers:output_type -> gateway.ListContainersResponse
	16, // 65: gateway.GatewayService.StopContainer:output_type -> gateway.StopContainerResponse
	18, // 66: gateway.GatewayService.StartTask:output_type -> gateway.StartTaskResponse
	20, // 67: gateway.GatewayService.EndTask:output_type -> gateway.EndTaskResponse
	26, // 68: gateway.GatewayService.StopTasks:output_type -> gateway.StopTasksResponse
	24, // 69: gateway.GatewayService.ListTasks:output_type -> gateway.ListTasksResponse
	32, // 70: gateway.GatewayService.GetOrCreateStub:output_type -> gateway.GetOrCreateStubResponse
	34, // 71: gateway.GatewayService.DeployStub:output_type -> gateway.DeployStubResponse
	37, // 72: gateway.GatewayService.ListDeployments:output_type -> gateway.ListDeploymentsResponse
	39, // 73: gateway.GatewayService.StopDeployment:output_type -> gateway.StopDeploymentResponse
	41, // 74: gateway.GatewayService.DeleteDeployment:output_type -> gateway.DeleteDeploymentResponse
	44, // 75: gateway.GatewayService.ListPools:output_type -> gateway.ListPoolsResponse
	48, // 76: gateway.GatewayService.ListMachines:output_type -> gateway.ListMachinesResponse
	50, // 77: gateway.GatewayService.CreateMachine:output_type -> gateway.CreateMachineResponse
	52, // 78: gateway.GatewayService.DeleteMachine:output_type -> gateway.DeleteMachineResponse
	55, // 79: gateway.GatewayService.ListTokens:output_type -> gateway.ListTokensResponse
	57, // 80: gateway.GatewayService.CreateToken:output_type -> gateway.CreateTokenResponse
	59, // 81: gateway.GatewayService.ToggleToken:output_type -> gateway.ToggleTokenResponse
	61, // 82: gateway.GatewayService.DeleteToken:output_type -> gateway.DeleteTokenResponse
