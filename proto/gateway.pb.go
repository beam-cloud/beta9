...
var file_gateway_proto_rawDesc = []byte{
	...
	0x68, 0x69, 0x6e, 0x65, 0x73, 0x22, 0x16, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4d,
	0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x6c, 0x0a,
	...
	0x6e, 0x65, 0x52, 0x07, 0x6d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x2a, 0x36, 0x0a, 0x1d, 0x52,
	...
	0x45, 0x10, 0x01, 0x32, 0xee, 0x0a, 0x0a, 0x0e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x53,
...
var file_gateway_proto_depIdxs = []int32{
	...
	46, // 3: gateway.Container.scheduled_at:type_name -> google.protobuf.Timestamp
	...
	46, // 6: gateway.Task.started_at:type_name -> google.protobuf.Timestamp
	46, // 7: gateway.Task.ended_at:type_name -> google.protobuf.Timestamp
	46, // 8: gateway.Task.created_at:type_name -> google.protobuf.Timestamp
	46, // 9: gateway.Task.updated_at:type_name -> google.protobuf.Timestamp
	...
	46, // 12: gateway.Deployment.created_at:type_name -> google.protobuf.Timestamp
	46, // 13: gateway.Deployment.updated_at:type_name -> google.protobuf.Timestamp
	...
	2,  // 41: gateway.GatewayService.Authorize:output_type -> gateway.AuthorizeResponse
	4,  // 42: gateway.GatewayService.SignPayload:output_type -> gateway.SignPayloadResponse
	7,  // 43: gateway.GatewayService.HeadObject:output_type -> gateway.HeadObjectResponse
	9,  // 44: gateway.GatewayService.PutObject:output_type -> gateway.PutObjectResponse
	9,  // 45: gateway.GatewayService.PutObjectStream:output_type -> gateway.PutObjectResponse
	11, // 46: gateway.GatewayService.ReplaceObjectContent:output_type -> gateway.ReplaceObjectContentResponse
	14, // 47: gateway.GatewayService.ListContainers:output_type -> gateway.ListContainersResponse
	16, // 48: gateway.GatewayService.StartTask:output_type -> gateway.StartTaskResponse
	18, // 49: gateway.GatewayService.EndTask:output_type -> gateway.EndTaskResponse
	24, // 50: gateway.GatewayService.StopTasks:output_type -> gateway.StopTasksResponse
	22, // 51: gateway.GatewayService.ListTasks:output_type -> gateway.ListTasksResponse
	27, // 52: gateway.GatewayService.GetOrCreateStub:output_type -> gateway.GetOrCreateStubResponse
	29, // 53: gateway.GatewayService.DeployStub:output_type -> gateway.DeployStubResponse
	32, // 54: gateway.GatewayService.ListDeployments:output_type -> gateway.ListDeploymentsResponse
	34, // 55: gateway.GatewayService.StopDeployment:output_type -> gateway.StopDeploymentResponse
	37, // 56: gateway.GatewayService.ListPools:output_type -> gateway.ListPoolsResponse
	40, // 57: gateway.GatewayService.ListMachines:output_type -> gateway.ListMachinesResponse
	42, // 58: gateway.GatewayService.CreateMachine:output_type -> gateway.CreateMachineResponse
