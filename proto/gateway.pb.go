...
type GetOrCreateStubRequest struct {
	...
	Extra           string       `protobuf:"bytes,24,opt,name=extra,proto3" json:"extra,omitempty"`
}
...
var file_gateway_proto_rawDesc = []byte{
	...
	0x22, 0xff, 0x05, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x52, 0x0a, 0x74, 0x61, 0x73, 0x6b, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x14, 0x0a, 0x05,
	0x65, 0x78, 0x74, 0x72, 0x61, 0x18, 0x18, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x78, 0x74,
	0x72, 0x61, 0x22, 0x76, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x2e, 0x50, 0x6f, 0x6f, 0x6c, 0x52, 0x05, 0x70, 0x6f, 0x6f, 0x6c, 0x73, 0x22, 0xef, 0x03, 0x0a,
	...
	0x6d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x22, 0xf3,
	...
	0x72, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x2a, 0x41, 0x0a,
	...
	0x32, 0xc7, 0x0f, 0x0a, 0x0e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x53, 0x65, 0x72, 0x76,
	...
	0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x23, 0x5a, 0x21, 0x67, 0x69,
...
var file_gateway_proto_depIdxs = []int32{
	...
	69, // 3: gateway.Container.scheduled_at:type_name -> google.protobuf.Timestamp
	...
	69, // 6: gateway.Task.started_at:type_name -> google.protobuf.Timestamp
	69, // 7: gateway.Task.ended_at:type_name -> google.protobuf.Timestamp
	69, // 8: gateway.Task.created_at:type_name -> google.protobuf.Timestamp
	69, // 9: gateway.Task.updated_at:type_name -> google.protobuf.Timestamp
	...
	69, // 16: gateway.Deployment.created_at:type_name -> google.protobuf.Timestamp
	69, // 17: gateway.Deployment.updated_at:type_name -> google.protobuf.Timestamp
	...
	69, // 26: gateway.Token.created_at:type_name -> google.protobuf.Timestamp
	69, // 27: gateway.Token.updated_at:type_name -> google.protobuf.Timestamp
	...
	21, // 31: gateway.ListTasksRequest.FiltersEntry.value:type_name -> gateway.StringList
	21, // 32: gateway.ListDeploymentsRequest.FiltersEntry.value:type_name -> gateway.StringList
	21, // 33: gateway.ListPoolsRequest.FiltersEntry.value:type_name -> gateway.StringList
	...
	13, // 40: gateway.GatewayService.ListContainers:input_type -> gateway.ListContainersRequest
	15, // 41: gateway.GatewayService.StopContainer:input_type -> gateway.StopContainerRequest
	17, // 42: gateway.GatewayService.StartTask:input_type -> gateway.StartTaskRequest
	19, // 43: gateway.GatewayService.EndTask:input_type -> gateway.EndTaskRequest
	25, // 44: gateway.GatewayService.StopTasks:input_type -> gateway.StopTasksRequest
	22, // 45: gateway.GatewayService.ListTasks:input_type -> gateway.ListTasksRequest
	32, // 46: gateway.GatewayService.GetOrCreateStub:input_type -> gateway.GetOrCreateStubRequest
	34, // 47: gateway.GatewayService.DeployStub:input_type -> gateway.DeployStubRequest
	...
	2,  // 60: gateway.GatewayService.Authorize:output_type -> gateway.AuthorizeResponse
	4,  // 61: gateway.GatewayService.SignPayload:output_type -> gateway.SignPayloadResponse
	7,  // 62: gateway.GatewayService.HeadObject:output_type -> gateway.HeadObjectResponse
	9,  // 63: gateway.GatewayService.PutObject:output_type -> gateway.PutObjectResponse
	9,  // 64: gateway.GatewayService.PutObjectStream:output_type -> gateway.PutObjectResponse
	11, // 65: gateway.GatewayService.ReplaceObjectContent:output_type -> gateway.ReplaceObjectContentResponse
	14, // 66: gateway.GatewayService.ListContainers:output_type -> gateway.ListContainersResponse
	16, // 67: gateway.GatewayService.StopContainer:output_type -> gateway.StopContainerResponse
	18, // 68: gateway.GatewayService.StartTask:output_type -> gateway.StartTaskResponse
	20, // 69: gateway.GatewayService.EndTask:output_type -> gateway.EndTaskResponse
	26, // 70: gateway.GatewayService.StopTasks:output_type -> gateway.StopTasksResponse
	24, // 71: gateway.GatewayService.ListTasks:output_type -> gateway.ListTasksResponse
	33, // 72: gateway.GatewayService.GetOrCreateStub:output_type -> gateway.GetOrCreateStubResponse
	35, // 73: gateway.GatewayService.DeployStub:output_type -> gateway.DeployStubResponse
	64, // 74: gateway.GatewayService.GetURL:output_type -> gateway.GetURLResponse
