...
type Worker struct {
	...
	ActiveContainers uint32 `protobuf:"varint,13,opt,name=active_containers,json=activeContainers,proto3" json:"active_containers,omitempty"`
}
...
func (x *Worker) GetActiveContainers() uint32 {
	if x != nil {
...
var file_gateway_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x22, 0x91, 0x03, 0x0a, 0x06, 0x57, 0x6f, 0x72, 0x6b,
	...
	0x52, 0x0c, 0x66, 0x72, 0x65, 0x65, 0x47, 0x70, 0x75, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x2b,
	0x0a, 0x11, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e,
	0x65, 0x72, 0x73, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x10, 0x61, 0x63, 0x74, 0x69, 0x76,
	0x65, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x73, 0x22, 0x14, 0x0a, 0x12, 0x4c,
...
var file_gateway_proto_depIdxs = []int32{
	...
	65, // 31: gateway.ListWorkersResponse.workers:type_name -> gateway.Worker
	21, // 32: gateway.ListTasksRequest.FiltersEntry.value:type_name -> gateway.StringList
	21, // 33: gateway.ListDeploymentsRequest.FiltersEntry.value:type_name -> gateway.StringList
	21, // 34: gateway.ListPoolsRequest.FiltersEntry.value:type_name -> gateway.StringList
	...
	13, // 41: gateway.GatewayService.ListContainers:input_type -> gateway.ListContainersRequest
	15, // 42: gateway.GatewayService.StopContainer:input_type -> gateway.StopContainerRequest
	17, // 43: gateway.GatewayService.StartTask:input_type -> gateway.StartTaskRequest
	19, // 44: gateway.GatewayService.EndTask:input_type -> gateway.EndTaskRequest
	25, // 45: gateway.GatewayService.StopTasks:input_type -> gateway.StopTasksRequest
	22, // 46: gateway.GatewayService.ListTasks:input_type -> gateway.ListTasksRequest
	32, // 47: gateway.GatewayService.GetOrCreateStub:input_type -> gateway.GetOrCreateStubRequest
	34, // 48: gateway.GatewayService.DeployStub:input_type -> gateway.DeployStubRequest
	63, // 49: gateway.GatewayService.GetURL:input_type -> gateway.GetURLRequest
	37, // 50: gateway.GatewayService.ListDeployments:input_type -> gateway.ListDeploymentsRequest
	39, // 51: gateway.GatewayService.StopDeployment:input_type -> gateway.StopDeploymentRequest
	41, // 52: gateway.GatewayService.DeleteDeployment:input_type -> gateway.DeleteDeploymentRequest
	44, // 53: gateway.GatewayService.ListPools:input_type -> gateway.ListPoolsRequest
	48, // 54: gateway.GatewayService.ListMachines:input_type -> gateway.ListMachinesRequest
	50, // 55: gateway.GatewayService.CreateMachine:input_type -> gateway.CreateMachineRequest
	52, // 56: gateway.GatewayService.DeleteMachine:input_type -> gateway.DeleteMachineRequest
	55, // 57: gateway.GatewayService.ListTokens:input_type -> gateway.ListTokensRequest
	57, // 58: gateway.GatewayService.CreateToken:input_type -> gateway.CreateTokenRequest
	59, // 59: gateway.GatewayService.ToggleToken:input_type -> gateway.ToggleTokenRequest
	61, // 60: gateway.GatewayService.DeleteToken:input_type -> gateway.DeleteTokenRequest
	66, // 61: gateway.GatewayService.ListWorkers:input_type -> gateway.ListWorkersRequest
	68, // 62: gateway.GatewayService.CordonWorker:input_type -> gateway.CordonWorkerRequest
	70, // 63: gateway.GatewayService.UncordonWorker:input_type -> gateway.UncordonWorkerRequest
	72, // 64: gateway.GatewayService.DrainWorker:input_type -> gateway.DrainWorkerRequest
	2,  // 65: gateway.GatewayService.Authorize:output_type -> gateway.AuthorizeResponse
	4,  // 66: gateway.GatewayService.SignPayload:output_type -> gateway.SignPayloadResponse
	7,  // 67: gateway.GatewayService.HeadObject:output_type -> gateway.HeadObjectResponse
	9,  // 68: gateway.GatewayService.PutObject:output_type -> gateway.PutObjectResponse
	9,  // 69: gateway.GatewayService.PutObjectStream:output_type -> gateway.PutObjectResponse
	11, // 70: gateway.GatewayService.ReplaceObjectContent:output_type -> gateway.ReplaceObjectContentResponse
	14, // 71: gateway.GatewayService.ListContainers:output_type -> gateway.ListContainersResponse
	16, // 72: gateway.GatewayService.StopContainer:output_type -> gateway.StopContainerResponse
	18, // 73: gateway.GatewayService.StartTask:output_type -> gateway.StartTaskResponse
	20, // 74: gateway.GatewayService.EndTask:output_type -> gateway.EndTaskResponse
	26, // 75: gateway.GatewayService.StopTasks:output_type -> gateway.StopTasksResponse
	24, // 76: gateway.GatewayService.ListTasks:output_type -> gateway.ListTasksResponse
	33, // 77: gateway.GatewayService.GetOrCreateStub:output_type -> gateway.GetOrCreateStubResponse
	35, // 78: gateway.GatewayService.DeployStub:output_type -> gateway.DeployStubResponse
	64, // 79: gateway.GatewayService.GetURL:output_type -> gateway.GetURLResponse
	38, // 80: gateway.GatewayService.ListDeployments:output_type -> gateway.ListDeploymentsResponse
	40, // 81: gateway.GatewayService.StopDeployment:output_type -> gateway.StopDeploymentResponse
	42, // 82: gateway.GatewayService.DeleteDeployment:output_type -> gateway.DeleteDeploymentResponse
	45, // 83: gateway.GatewayService.ListPools:output_type -> gateway.ListPoolsResponse
	49, // 84: gateway.GatewayService.ListMachines:output_type -> gateway.ListMachinesResponse
	51, // 85: gateway.GatewayService.CreateMachine:output_type -> gateway.CreateMachineResponse
	53, // 86: gateway.GatewayService.DeleteMachine:output_type -> gateway.DeleteMachineResponse
	56, // 87: gateway.GatewayService.ListTokens:output_type -> gateway.ListTokensResponse
	58, // 88: gateway.GatewayService.CreateToken:output_type -> gateway.CreateTokenResponse
	60, // 89: gateway.GatewayService.ToggleToken:output_type -> gateway.ToggleTokenResponse
	62, // 90: gateway.GatewayService.DeleteToken:output_type -> gateway.DeleteTokenResponse
	67, // 91: gateway.GatewayService.ListWorkers:output_type -> gateway.ListWorkersResponse
	69, // 92: gateway.GatewayService.CordonWorker:output_type -> gateway.CordonWorkerResponse
	71, // 93: gateway.GatewayService.UncordonWorker:output_type -> gateway.UncordonWorkerResponse
	73, // 94: gateway.GatewayService.DrainWorker:output_type -> gateway.DrainWorkerResponse
