...
var file_gateway_proto_rawDesc = []byte{
	...
	0x06, 0x65, 0x72, 0x72, 0x4d, 0x73, 0x67, 0x2a, 0x36, 0x0a, 0x1d, 0x52, 0x65, 0x70, 0x6c, 0x61,
	...
	0xb8, 0x08, 0x0a, 0x0e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x01, 0x12, 0x67, 0x0a, 0x14, 0x52, 0x65, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x4f, 0x62, 0x6a, 0x65,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x42, 0x0a, 0x09, 0x53, 0x74,
...
var file_gateway_proto_goTypes = []interface{}{
	...
	nil,                                  // 32: gateway.ListTasksRequest.FiltersEntry
	nil,                                  // 33: gateway.ListDeploymentsRequest.FiltersEntry
...
var file_gateway_proto_depIdxs = []int32{
	...
	32, // 3: gateway.ListTasksRequest.filters:type_name -> gateway.ListTasksRequest.FiltersEntry
	34, // 4: gateway.Task.started_at:type_name -> google.protobuf.Timestamp
	34, // 5: gateway.Task.ended_at:type_name -> google.protobuf.Timestamp
	34, // 6: gateway.Task.created_at:type_name -> google.protobuf.Timestamp
	34, // 7: gateway.Task.updated_at:type_name -> google.protobuf.Timestamp
	...
	34, // 10: gateway.Deployment.created_at:type_name -> google.protobuf.Timestamp
	34, // 11: gateway.Deployment.updated_at:type_name -> google.protobuf.Timestamp
	33, // 12: gateway.ListDeploymentsRequest.filters:type_name -> gateway.ListDeploymentsRequest.FiltersEntry
	27, // 13: gateway.ListDeploymentsResponse.deployments:type_name -> gateway.Deployment
	16, // 14: gateway.ListTasksRequest.FiltersEntry.value:type_name -> gateway.StringList
	16, // 15: gateway.ListDeploymentsRequest.FiltersEntry.value:type_name -> gateway.StringList
	1,  // 16: gateway.GatewayService.Authorize:input_type -> gateway.AuthorizeRequest
	3,  // 17: gateway.GatewayService.SignPayload:input_type -> gateway.SignPayloadRequest
	6,  // 18: gateway.GatewayService.HeadObject:input_type -> gateway.HeadObjectRequest
	8,  // 19: gateway.GatewayService.PutObject:input_type -> gateway.PutObjectRequest
	8,  // 20: gateway.GatewayService.PutObjectStream:input_type -> gateway.PutObjectRequest
	10, // 21: gateway.GatewayService.ReplaceObjectContent:input_type -> gateway.ReplaceObjectContentRequest
	12, // 22: gateway.GatewayService.StartTask:input_type -> gateway.StartTaskRequest
	14, // 23: gateway.GatewayService.EndTask:input_type -> gateway.EndTaskRequest
	20, // 24: gateway.GatewayService.StopTasks:input_type -> gateway.StopTasksRequest
	17, // 25: gateway.GatewayService.ListTasks:input_type -> gateway.ListTasksRequest
	23, // 26: gateway.GatewayService.GetOrCreateStub:input_type -> gateway.GetOrCreateStubRequest
	25, // 27: gateway.GatewayService.DeployStub:input_type -> gateway.DeployStubRequest
	28, // 28: gateway.GatewayService.ListDeployments:input_type -> gateway.ListDeploymentsRequest
	30, // 29: gateway.GatewayService.StopDeployment:input_type -> gateway.StopDeploymentRequest
	2,  // 30: gateway.GatewayService.Authorize:output_type -> gateway.AuthorizeResponse
	4,  // 31: gateway.GatewayService.SignPayload:output_type -> gateway.SignPayloadResponse
	7,  // 32: gateway.GatewayService.HeadObject:output_type -> gateway.HeadObjectResponse
	9,  // 33: gateway.GatewayService.PutObject:output_type -> gateway.PutObjectResponse
	9,  // 34: gateway.GatewayService.PutObjectStream:output_type -> gateway.PutObjectResponse
	11, // 35: gateway.GatewayService.ReplaceObjectContent:output_type -> gateway.ReplaceObjectContentResponse
	13, // 36: gateway.GatewayService.StartTask:output_type -> gateway.StartTaskResponse
	15, // 37: gateway.GatewayService.EndTask:output_type -> gateway.EndTaskResponse
	21, // 38: gateway.GatewayService.StopTasks:output_type -> gateway.StopTasksResponse
	19, // 39: gateway.GatewayService.ListTasks:output_type -> gateway.ListTasksResponse
	24, // 40: gateway.GatewayService.GetOrCreateStub:output_type -> gateway.GetOrCreateStubResponse
	26, // 41: gateway.GatewayService.DeployStub:output_type -> gateway.DeployStubResponse
	29, // 42: gateway.GatewayService.ListDeployments:output_type -> gateway.ListDeploymentsResponse
	31, // 43: gateway.GatewayService.StopDeployment:output_type -> gateway.StopDeploymentResponse
