...
type GetOrCreateStubRequest struct {
	...
	RetryFor           []string     `protobuf:"bytes,26,rep,name=retry_for,json=retryFor,proto3" json:"retry_for,omitempty"`
}
...
func (x *GetOrCreateStubRequest) GetRetryFor() []string {
	if x != nil {
		return x.RetryFor
	}
	return nil
...
var file_gateway_proto_rawDesc = []byte{
	...
	0x1b, 0x0a, 0x09, 0x72, 0x65, 0x74, 0x72, 0x79, 0x5f, 0x66, 0x6f, 0x72, 0x18, 0x1a, 0x20, 0x03,
	0x28, 0x09, 0x52, 0x08, 0x72, 0x65, 0x74, 0x72, 0x79, 0x46, 0x6f, 0x72, 0x22, 0x76, 0x0a, 0x17,
