...
var file_gateway_proto_rawDesc = []byte{
	...
	0x52, 0x0a, 0x74, 0x61, 0x73, 0x6b, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x22, 0x5b, 0x0a, 0x17,
	...
	0x05, 0x4d, 0x4f, 0x56, 0x45, 0x44, 0x10, 0x02, 0x32, 0x8c, 0x0f, 0x0a, 0x0e, 0x47, 0x61, 0x74,
...
var file_gateway_proto_msgTypes = make([]protoimpl.MessageInfo, 66)
var file_gateway_proto_goTypes = []interface{}{
	...
	nil,                                  // 63: gateway.ListTasksRequest.FiltersEntry
	nil,                                  // 64: gateway.ListDeploymentsRequest.FiltersEntry
	nil,                                  // 65: gateway.ListPoolsRequest.FiltersEntry
	nil,                                  // 66: gateway.ListMachinesResponse.GpusEntry
...
var file_gateway_proto_depIdxs = []int32{
	...
	67, // 3: gateway.Container.scheduled_at:type_name -> google.protobuf.Timestamp
	12, // 4: gateway.ListContainersResponse.containers:type_name -> gateway.Container
	63, // 5: gateway.ListTasksRequest.filters:type_name -> gateway.ListTasksRequest.FiltersEntry
	67, // 6: gateway.Task.started_at:type_name -> google.protobuf.Timestamp
	67, // 7: gateway.Task.ended_at:type_name -> google.protobuf.Timestamp
	67, // 8: gateway.Task.created_at:type_name -> google.protobuf.Timestamp
	67, // 9: gateway.Task.updated_at:type_name -> google.protobuf.Timestamp
	...
	67, // 16: gateway.Deployment.created_at:type_name -> google.protobuf.Timestamp
	67, // 17: gateway.Deployment.updated_at:type_name -> google.protobuf.Timestamp
	64, // 18: gateway.ListDeploymentsRequest.filters:type_name -> gateway.ListDeploymentsRequest.FiltersEntry
	36, // 19: gateway.ListDeploymentsResponse.deployments:type_name -> gateway.Deployment
	65, // 20: gateway.ListPoolsRequest.filters:type_name -> gateway.ListPoolsRequest.FiltersEntry
	...
	66, // 24: gateway.ListMachinesResponse.gpus:type_name -> gateway.ListMachinesResponse.GpusEntry
	46, // 25: gateway.CreateMachineResponse.machine:type_name -> gateway.Machine
	67, // 26: gateway.Token.created_at:type_name -> google.protobuf.Timestamp
	67, // 27: gateway.Token.updated_at:type_name -> google.protobuf.Timestamp
	...
	37, // 48: gateway.GatewayService.ListDeployments:input_type -> gateway.ListDeploymentsRequest
	39, // 49: gateway.GatewayService.StopDeployment:input_type -> gateway.StopDeploymentRequest
	41, // 50: gateway.GatewayService.DeleteDeployment:input_type -> gateway.DeleteDeploymentRequest
	44, // 51: gateway.GatewayService.ListPools:input_type -> gateway.ListPoolsRequest
	48, // 52: gateway.GatewayService.ListMachines:input_type -> gateway.ListMachinesRequest
	50, // 53: gateway.GatewayService.CreateMachine:input_type -> gateway.CreateMachineRequest
	52, // 54: gateway.GatewayService.DeleteMachine:input_type -> gateway.DeleteMachineRequest
	55, // 55: gateway.GatewayService.ListTokens:input_type -> gateway.ListTokensRequest
	57, // 56: gateway.GatewayService.CreateToken:input_type -> gateway.CreateTokenRequest
	59, // 57: gateway.GatewayService.ToggleToken:input_type -> gateway.ToggleTokenRequest
	61, // 58: gateway.GatewayService.DeleteToken:input_type -> gateway.DeleteTokenRequest
	2,  // 59: gateway.GatewayService.Authorize:output_type -> gateway.AuthorizeResponse
	4,  // 60: gateway.GatewayService.SignPayload:output_type -> gateway.SignPayloadResponse
	7,  // 61: gateway.GatewayService.HeadObject:output_type -> gateway.HeadObjectResponse
	9,  // 62: gateway.GatewayService.PutObject:output_type -> gateway.PutObjectResponse
	9,  // 63: gateway.GatewayService.PutObjectStream:output_type -> gateway.PutObjectResponse
	11, // 64: gateway.GatewayService.ReplaceObjectContent:output_type -> gateway.ReplaceObjectContentResponse
	14, // 65: gateway.GatewayService.ListContainers:output_type -> gateway.ListContainersResponse
	16, // 66: gateway.GatewayService.StopContainer:output_type -> gateway.StopContainerResponse
	18, // 67: gateway.GatewayService.StartTask:output_type -> gateway.StartTaskResponse
	20, // 68: gateway.GatewayService.EndTask:output_type -> gateway.EndTaskResponse
	26, // 69: gateway.GatewayService.StopTasks:output_type -> gateway.StopTasksResponse
	24, // 70: gateway.GatewayService.ListTasks:output_type -> gateway.ListTasksResponse
	33, // 71: gateway.GatewayService.GetOrCreateStub:output_type -> gateway.GetOrCreateStubResponse
	35, // 72: gateway.GatewayService.DeployStub:output_type -> gateway.DeployStubResponse
	38, // 73: gateway.GatewayService.ListDeployments:output_type -> gateway.ListDeploymentsResponse
	40, // 74: gateway.GatewayService.StopDeployment:output_type -> gateway.StopDeploymentResponse
	42, // 75: gateway.GatewayService.DeleteDeployment:output_type -> gateway.DeleteDeploymentResponse
	45, // 76: gateway.GatewayService.ListPools:output_type -> gateway.ListPoolsResponse
	49, // 77: gateway.GatewayService.ListMachines:output_type -> gateway.ListMachinesResponse
	51, // 78: gateway.GatewayService.CreateMachine:output_type -> gateway.CreateMachineResponse
	53, // 79: gateway.GatewayService.DeleteMachine:output_type -> gateway.DeleteMachineResponse
	56, // 80: gateway.GatewayService.ListTokens:output_type -> gateway.ListTokensResponse
	58, // 81: gateway.GatewayService.CreateToken:output_type -> gateway.CreateTokenResponse
	60, // 82: gateway.GatewayService.ToggleToken:output_type -> gateway.ToggleTokenResponse
	62, // 83: gateway.GatewayService.DeleteToken:output_type -> gateway.DeleteTokenResponse
