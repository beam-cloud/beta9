...
var file_gateway_proto_rawDesc = []byte{
	...
	0x72, 0x72, 0x4d, 0x73, 0x67, 0x22, 0xe4, 0x01, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x43,
	...
	0x75, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x67, 0x70, 0x75, 0x22, 0x42, 0x0a, 0x17,
	...
	0x32, 0xc2, 0x04, 0x0a, 0x0e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x53, 0x65, 0x72, 0x76,
...
var file_gateway_proto_goTypes = []interface{}{
	...
	nil,                             // 19: gateway.ListTasksRequest.FiltersEntry
...
var file_gateway_proto_depIdxs = []int32{
	...
	19, // 2: gateway.ListTasksRequest.filters:type_name -> gateway.ListTasksRequest.FiltersEntry
	20, // 3: gateway.Task.started_at:type_name -> google.protobuf.Timestamp
	20, // 4: gateway.Task.ended_at:type_name -> google.protobuf.Timestamp
	20, // 5: gateway.Task.created_at:type_name -> google.protobuf.Timestamp
	20, // 6: gateway.Task.updated_at:type_name -> google.protobuf.Timestamp
	13, // 7: gateway.ListTasksResponse.tasks:type_name -> gateway.Task
	11, // 8: gateway.ListTasksRequest.FiltersEntry.value:type_name -> gateway.StringList
	0,  // 9: gateway.GatewayService.Authorize:input_type -> gateway.AuthorizeRequest
	3,  // 10: gateway.GatewayService.HeadObject:input_type -> gateway.HeadObjectRequest
	5,  // 11: gateway.GatewayService.PutObject:input_type -> gateway.PutObjectRequest
	7,  // 12: gateway.GatewayService.StartTask:input_type -> gateway.StartTaskRequest
	9,  // 13: gateway.GatewayService.EndTask:input_type -> gateway.EndTaskRequest
	15, // 14: gateway.GatewayService.StopTask:input_type -> gateway.StopTaskRequest
	12, // 15: gateway.GatewayService.ListTasks:input_type -> gateway.ListTasksRequest
	17, // 16: gateway.GatewayService.GetOrCreateStub:input_type -> gateway.GetOrCreateStubRequest
	1,  // 17: gateway.GatewayService.Authorize:output_type -> gateway.AuthorizeResponse
	4,  // 18: gateway.GatewayService.HeadObject:output_type -> gateway.HeadObjectResponse
	6,  // 19: gateway.GatewayService.PutObject:output_type -> gateway.PutObjectResponse
	8,  // 20: gateway.GatewayService.StartTask:output_type -> gateway.StartTaskResponse
	10, // 21: gateway.GatewayService.EndTask:output_type -> gateway.EndTaskResponse
	16, // 22: gateway.GatewayService.StopTask:output_type -> gateway.StopTaskResponse
	14, // 23: gateway.GatewayService.ListTasks:output_type -> gateway.ListTasksResponse
	18, // 24: gateway.GatewayService.GetOrCreateStub:output_type -> gateway.GetOrCreateStubResponse
