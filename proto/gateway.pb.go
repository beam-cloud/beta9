...
type GetOrCreateStubRequest struct {
	...
	OnDeployId         string       `protobuf:"bytes,29,opt,name=on_deploy_id,json=onDeployId,proto3" json:"on_deploy_id,omitempty"`
}
...
func (x *GetOrCreateStubRequest) GetOnDeployId() string {
	if x != nil {
		return x.OnDeployId
	}
	return ""
...
var file_gateway_proto_rawDesc = []byte{
	...
	0x03, 0x74, 0x74, 0x6c, 0x22, 0xbb, 0x07, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x43, 0x72,
	...
	0x12, 0x20, 0x0a, 0x0c, 0x6f, 0x6e, 0x5f, 0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x5f, 0x69, 0x64,
	0x18, 0x1d, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6f, 0x6e, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79,
