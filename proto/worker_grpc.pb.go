...
type RunCServiceClient interface {
	...
	RunCStreamLogs(ctx context.Context, in *RunCStreamLogsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RunCLogEntry], error)
	RunCArchive(ctx context.Context, in *RunCArchiveRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RunCArchiveResponse], error)
}
...
func (c *runCServiceClient) RunCStreamLogs(ctx context.Context, in *RunCStreamLogsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RunCLogEntry], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &RunCService_ServiceDesc.Streams[0], RunCService_RunCStreamLogs_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[RunCStreamLogsRequest, RunCLogEntry]{ClientStream: stream}
...
type RunCService_RunCStreamLogsClient = grpc.ServerStreamingClient[RunCLogEntry]

func (c *runCServiceClient) RunCArchive(ctx context.Context, in *RunCArchiveRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RunCArchiveResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &RunCService_ServiceDesc.Streams[1], RunCService_RunCArchive_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[RunCArchiveRequest, RunCArchiveResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RunCService_RunCArchiveClient = grpc.ServerStreamingClient[RunCArchiveResponse]
...
type RunCServiceServer interface {
	...
	RunCStreamLogs(*RunCStreamLogsRequest, grpc.ServerStreamingServer[RunCLogEntry]) error
	RunCArchive(*RunCArchiveRequest, grpc.ServerStreamingServer[RunCArchiveResponse]) error
...
func (UnimplementedRunCServiceServer) RunCStreamLogs(*RunCStreamLogsRequest, grpc.ServerStreamingServer[RunCLogEntry]) error {
	return status.Errorf(codes.Unimplemented, "method RunCStreamLogs not implemented")
}
func (UnimplementedRunCServiceServer) RunCArchive(*RunCArchiveRequest, grpc.ServerStreamingServer[RunCArchiveResponse]) error {
...
func _RunCService_RunCStreamLogs_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(RunCServiceServer).RunCStreamLogs(m, &grpc.GenericServerStream[RunCStreamLogsRequest, RunCLogEntry]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RunCService_RunCStreamLogsServer = grpc.ServerStreamingServer[RunCLogEntry]
...
func _RunCService_RunCArchive_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(RunCServiceServer).RunCArchive(m, &grpc.GenericServerStream[RunCArchiveRequest, RunCArchiveResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RunCService_RunCArchiveServer = grpc.ServerStreamingServer[RunCArchiveResponse]
