...
var file_volume_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x6e, 0x65, 0x77, 0x50, 0x61, 0x74, 0x68, 0x32, 0x94, 0x04, 0x0a,
...
var file_volume_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_volume_proto_goTypes = []any{
	...
	(*DeleteVolumeRequest)(nil),       // 3: volume.DeleteVolumeRequest
	(*DeleteVolumeResponse)(nil),      // 4: volume.DeleteVolumeResponse
	(*PathInfo)(nil),                  // 5: volume.PathInfo
	(*ListPathRequest)(nil),           // 6: volume.ListPathRequest
	(*ListPathResponse)(nil),          // 7: volume.ListPathResponse
	(*DeletePathRequest)(nil),         // 8: volume.DeletePathRequest
	(*DeletePathResponse)(nil),        // 9: volume.DeletePathResponse
	(*CopyPathRequest)(nil),           // 10: volume.CopyPathRequest
	(*CopyPathResponse)(nil),          // 11: volume.CopyPathResponse
	(*ListVolumesRequest)(nil),        // 12: volume.ListVolumesRequest
	(*ListVolumesResponse)(nil),       // 13: volume.ListVolumesResponse
	(*MovePathRequest)(nil),           // 14: volume.MovePathRequest
	(*MovePathResponse)(nil),          // 15: volume.MovePathResponse
	(*timestamppb.Timestamp)(nil),     // 16: google.protobuf.Timestamp
}
var file_volume_proto_depIdxs = []int32{
	16, // 0: volume.VolumeInstance.created_at:type_name -> google.protobuf.Timestamp
	16, // 1: volume.VolumeInstance.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 2: volume.GetOrCreateVolumeResponse.volume:type_name -> volume.VolumeInstance
	16, // 3: volume.PathInfo.mod_time:type_name -> google.protobuf.Timestamp
	5,  // 4: volume.ListPathResponse.path_infos:type_name -> volume.PathInfo
	...
	3,  // 7: volume.VolumeService.DeleteVolume:input_type -> volume.DeleteVolumeRequest
	12, // 8: volume.VolumeService.ListVolumes:input_type -> volume.ListVolumesRequest
	6,  // 9: volume.VolumeService.ListPath:input_type -> volume.ListPathRequest
	8,  // 10: volume.VolumeService.DeletePath:input_type -> volume.DeletePathRequest
	10, // 11: volume.VolumeService.CopyPathStream:input_type -> volume.CopyPathRequest
	14, // 12: volume.VolumeService.MovePath:input_type -> volume.MovePathRequest
	2,  // 13: volume.VolumeService.GetOrCreateVolume:output_type -> volume.GetOrCreateVolumeResponse
	4,  // 14: volume.VolumeService.DeleteVolume:output_type -> volume.DeleteVolumeResponse
	13, // 15: volume.VolumeService.ListVolumes:output_type -> volume.ListVolumesResponse
	7,  // 16: volume.VolumeService.ListPath:output_type -> volume.ListPathResponse
	9,  // 17: volume.VolumeService.DeletePath:output_type -> volume.DeletePathResponse
	11, // 18: volume.VolumeService.CopyPathStream:output_type -> volume.CopyPathResponse
	15, // 19: volume.VolumeService.MovePath:output_type -> volume.MovePathResponse
...
func file_volume_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_volume_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_volume_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_volume_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_volume_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_volume_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_volume_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_volume_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_volume_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_volume_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_volume_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_volume_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_volume_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_volume_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_volume_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_volume_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_volume_proto_msgTypes[15].Exporter = func(v any, i int) any {
