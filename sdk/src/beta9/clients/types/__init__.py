...
class ContainerRequest(betterproto.Message):
    ...
    machine_id: str = betterproto.string_field(33)
    checkpoint_trigger: "CheckpointTrigger" = betterproto.message_field(34)
    task_id: str = betterproto.string_field(35)
    hostname: str = betterproto.string_field(37)
    evictable: bool = betterproto.bool_field(39)
    opportunistic_only: bool = betterproto.bool_field(40)
    evict_container_ids: List[str] = betterproto.string_field(41)
    evict_drain_seconds: int = betterproto.uint32_field(42)
    drain_seconds: int = betterproto.uint32_field(43)
    evict_order: int = betterproto.int32_field(44)
