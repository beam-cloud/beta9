...
protoc -I ./pkg/abstractions/signal/ --go_out=./proto --go_opt=paths=source_relative --go-grpc_out=./proto --go-grpc_opt=paths=source_relative ./pkg/abstractions/signal/signal.proto
protoc -I ./pkg/abstractions/signal/ --python_betterproto_beta9_out=./sdk/src/beta9/clients/ ./pkg/abstractions/signal/signal.proto
