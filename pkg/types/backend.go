...
type Checkpoint struct {
	...
	ExposedPorts      []int64 `db:"exposed_ports" json:"exposed_ports" serializer:"exposed_ports"`
	CreatedAt         Time    `db:"created_at" json:"created_at" serializer:"created_at"`
...
func (c *Checkpoint) ToProto() *pb.Checkpoint {
	exposedPorts := make([]int64, len(c.ExposedPorts))
...
func NewCheckpointFromProto(in *pb.Checkpoint) *Checkpoint {
	exposedPorts := make([]int64, len(in.ExposedPorts))
