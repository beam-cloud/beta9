...
type ProviderMachineMetrics struct {
	...
	TotalDiskSpaceBytes  int     `json:"total_storage_available" redis:"total_storage_available"`
	...
	TotalDiskFreeBytes   int     `json:"total_storage_used" redis:"total_storage_used"`
