...
func (g *Gateway) registerRepositoryServices() error {
	wr := repositoryservices.NewWorkerRepositoryService(g.ctx, g.workerRepo, g.ContainerRepo, g.BackendRepo, g.EventRepo, g.RedisClient, g.Config, g.Config.Cache.Coordinator.Token)
