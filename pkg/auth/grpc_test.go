...
func TestAuthInterceptorLetsCacheRepositoryMethodsSelfAuthenticate(t *testing.T) {
	...
	for _, method := range []string{
		...
		pb.WorkerRepositoryService_ReportRequiredContent_FullMethodName,
		pb.WorkerRepositoryService_ListRecentRequiredContentStubs_FullMethodName,
		pb.WorkerRepositoryService_ListRequiredContentForStub_FullMethodName,
		pb.WorkerRepositoryService_SetRequiredContentReconciliationStatus_FullMethodName,
		pb.WorkerRepositoryService_ResolveRequiredContentOrigin_FullMethodName,
