...
const (
	...
	BotEventTypeConfirmTransitionRequest BotEventType = "confirm_transition_request"
	BotEventTypeConfirmTransitionAccept  BotEventType = "confirm_transition_accept"
	BotEventTypeConfirmTransitionReject  BotEventType = "confirm_transition_reject"
)
