...
func TestApplyRepoRejectsUnpublishablePricing(t *testing.T) {
	s := newServiceForTest(t)
	seedEndpoint(t, s)
	image := seedApp(t, s, "acme/image", types.EndpointKindImage, types.Pricing{Request: "0.10"})
