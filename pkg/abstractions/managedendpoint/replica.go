...
// A replica's life: the controller starts it, syncs it with its container
// and probes it each tick; the harness inside it registers, heartbeats and
// acknowledges live config over EndpointHarnessService.
...
// EndpointHarnessService: called from inside replica containers with the
