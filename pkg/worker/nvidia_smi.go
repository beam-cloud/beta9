...
type NvidiaSMIClientInterface interface {
...
func NewNvidiaSMIClient() NvidiaSMIClientInterface {
	return &NvidiaSMIClient{}
}

func (c *NvidiaSMIClient) hexToPaddedString(hexStr string) (string, error) {
...
func (c *NvidiaSMIClient) AvailableGPUDevices() ([]int, error) {
...
func (c *NvidiaSMIClient) GetGpuMemoryUsage(deviceIndex int) (GpuMemoryUsageStats, error) {
