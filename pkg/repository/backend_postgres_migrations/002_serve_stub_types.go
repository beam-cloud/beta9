...
func init() {
	goose.AddMigration(upAddStubTypes, downRemoveStubTypes)
}

func upAddStubTypes(tx *sql.Tx) error {
	newStubTypes := []string{"taskqueue/serve", "function/serve", "endpoint/serve"}
...
func downRemoveStubTypes(tx *sql.Tx) error {
