...
func init() {
	goose.AddMigration(upAddBotStubTypes, downRemoveBotStubTypes)
}

func upAddBotStubTypes(tx *sql.Tx) error {
	newStubTypes := []string{"bot", "bot/deployment", "bot/serve"}
...
func downRemoveBotStubTypes(tx *sql.Tx) error {
