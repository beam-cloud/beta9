...
func init() {
	goose.AddMigrationContext(upStorageCutover041, downStorageCutover041)
}
...
func upStorageCutover041(context.Context, *sql.Tx) error { return nil }

func downStorageCutover041(context.Context, *sql.Tx) error { return nil }
